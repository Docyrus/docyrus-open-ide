...
(() => {
  ...
  // node_modules/@pierre/trees/dist/builtInIcons.js
  var MINIMAL_SVG_SPRITE_SHEET = `<svg data-icon-sprite aria-hidden="true" width="0" height="0">
  ...
  var sym_astro = `<symbol id="file-tree-builtin-astro" viewBox="0 0 16 16">
  ...
  var sym_babel = `<symbol id="file-tree-builtin-babel" viewBox="0 0 16 16">
  ...
  var sym_bash = `<symbol id="file-tree-builtin-bash" viewBox="0 0 16 16">
  ...
  var sym_biome = `<symbol id="file-tree-builtin-biome" viewBox="0 0 16 16">
  ...
  var sym_bootstrap = `<symbol id="file-tree-builtin-bootstrap" viewBox="0 0 16 16">
  ...
  var sym_browserslist = `<symbol id="file-tree-builtin-browserslist" viewBox="0 0 16 16">
  ...
  var sym_bun = `<symbol id="file-tree-builtin-bun" viewBox="0 0 16 16">
  ...
  var sym_c = `<symbol id="file-tree-builtin-c" viewBox="0 0 16 16">
  ...
  var sym_claude = `<symbol id="file-tree-builtin-claude" viewBox="0 0 16 16">
  ...
  var sym_cpp = `<symbol id="file-tree-builtin-cpp" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clip-rule="evenodd"/>
</symbol>`;
  var sym_css = `<symbol id="file-tree-builtin-css" viewBox="0 0 16 16">
  ...
  var sym_database = `<symbol id="file-tree-builtin-database" viewBox="0 0 16 16">
  ...
  var sym_default = `<symbol id="file-tree-builtin-default" viewBox="0 0 16 16">
  ...
  var sym_docker = `<symbol id="file-tree-builtin-docker" viewBox="0 0 16 16">
  ...
  var sym_eslint = `<symbol id="file-tree-builtin-eslint" viewBox="0 0 16 16">
  ...
  var sym_font = `<symbol id="file-tree-builtin-font" viewBox="0 0 16 16">
  ...
  var sym_git = `<symbol id="file-tree-builtin-git" viewBox="0 0 16 16">
  ...
  var sym_go = `<symbol id="file-tree-builtin-go" viewBox="0 0 16 16">
  ...
  var sym_graphql = `<symbol id="file-tree-builtin-graphql" viewBox="0 0 16 16">
  ...
  var sym_html = `<symbol id="file-tree-builtin-html" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  ...
  var sym_image = `<symbol id="file-tree-builtin-image" viewBox="0 0 16 16">
  ...
  var sym_javascript = `<symbol id="file-tree-builtin-javascript" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  ...
  var sym_json = `<symbol id="file-tree-builtin-json" viewBox="0 0 16 16">
  ...
  var sym_markdown = `<symbol id="file-tree-builtin-markdown" viewBox="0 0 16 16">
  <path fill="currentColor" d="M1 12V4h2l2 2.5L7 4h2v8H7V7.5l-2 2-2-2V12zm9-3 3 3.5L16 9h-2V4h-2v5z"/>
</symbol>`;
  var sym_mcp = `<symbol id="file-tree-builtin-mcp" viewBox="0 0 16 16">
  ...
  var sym_nextjs = `<symbol id="file-tree-builtin-nextjs" viewBox="0 0 16 16">
  <defs>
  ...
  var sym_npm = `<symbol id="file-tree-builtin-npm" viewBox="0 0 16 16">
  ...
  var sym_oxc = `<symbol id="file-tree-builtin-oxc" viewBox="0 0 16 16">
  ...
  var sym_postcss = `<symbol id="file-tree-builtin-postcss" viewBox="0 0 16 16">
  ...
  var sym_prettier = `<symbol id="file-tree-builtin-prettier" viewBox="0 0 16 16">
  ...
  var sym_python = `<symbol id="file-tree-builtin-python" viewBox="0 0 16 16">
  ...
  var sym_react = `<symbol id="file-tree-builtin-react" viewBox="0 0 16 16">
  ...
  var sym_ruby = `<symbol id="file-tree-builtin-ruby" viewBox="0 0 16 16">
  ...
  var sym_rust = `<symbol id="file-tree-builtin-rust" viewBox="0 0 16 16">
  ...
  var sym_sass = `<symbol id="file-tree-builtin-sass" viewBox="0 0 16 16">
  ...
  var sym_stylelint = `<symbol id="file-tree-builtin-stylelint" viewBox="0 0 16 16">
  ...
  var sym_svelte = `<symbol id="file-tree-builtin-svelte" viewBox="0 0 16 16">
  ...
  var sym_svg = `<symbol id="file-tree-builtin-svg" viewBox="0 0 16 16">
  ...
  var sym_svgo = `<symbol id="file-tree-builtin-svgo" viewBox="0 0 16 16">
  ...
  var sym_swift = `<symbol id="file-tree-builtin-swift" viewBox="0 0 16 16">
  ...
  var sym_table = `<symbol id="file-tree-builtin-table" viewBox="0 0 16 16">
  ...
  var sym_tailwind = `<symbol id="file-tree-builtin-tailwind" viewBox="0 0 16 16">
  ...
  var sym_terraform = `<symbol id="file-tree-builtin-terraform" viewBox="0 0 16 16">
  ...
  var sym_text = `<symbol id="file-tree-builtin-text" viewBox="0 0 16 16">
  ...
  var sym_typescript = `<symbol id="file-tree-builtin-typescript" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  <path fill="currentColor" d="M8.1 9.64h.95c.04.62.28.76 1.28.76s1.2-.14 1.2-.85c0-.66-.2-.85-1.2-1.07-1.79-.38-2.18-.7-2.18-1.86C8.15 5.3 8.54 5 10.31 5c1.67 0 2.04.26 2.07 1.42h-.95c-.02-.43-.23-.53-1.1-.53-1 0-1.22.14-1.22.74 0 .52.22.7 1.24.92 1.76.38 2.15.73 2.15 2 0 1.44-.4 1.75-2.24 1.75-1.8 0-2.18-.3-2.15-1.66m-3 1.57V5.99H3.5v-.9h4.21v.9H6.1v5.22z"/>
</symbol>`;
  var sym_vite = `<symbol id="file-tree-builtin-vite" viewBox="0 0 16 16">
  ...
  var sym_vscode = `<symbol id="file-tree-builtin-vscode" viewBox="0 0 16 16">
  ...
  var sym_vue = `<symbol id="file-tree-builtin-vue" viewBox="0 0 16 16">
  ...
  var sym_wasm = `<symbol id="file-tree-builtin-wasm" viewBox="0 0 16 16">
  ...
  var sym_webpack = `<symbol id="file-tree-builtin-webpack" viewBox="0 0 16 16">
  ...
  var sym_yml = `<symbol id="file-tree-builtin-yml" viewBox="0 0 16 16">
  ...
  var sym_zig = `<symbol id="file-tree-builtin-zig" viewBox="0 0 16 16">
  ...
  var STANDARD_SVG_SPRITE_SHEET = appendSymbols(MINIMAL_SVG_SPRITE_SHEET, standardTierSymbols);
  var BUILT_IN_SVG_SPRITE_SHEETS = {
  ...
  var BUILT_IN_FILE_EXTENSION_TOKENS = {
    "7z": "zip",
    astro: "astro",
    AUTHORS: "text",
    avif: "image",
  ...
  var COMPLETE_EXTENSION_OVERRIDES = {
    jsx: "react",
    sass: "sass",
    scss: "sass",
    tsx: "react"
  };
  var STANDARD_TIER_TOKENS = /* @__PURE__ */ new Set([
    "bash",
    "c",
    "cpp",
    "css",
  ...
  var COLORED_SETS = /* @__PURE__ */ new Set(["complete"]);
  ...
  // node_modules/@pierre/trees/dist/constants.js
  var FILE_TREE_TAG_NAME = "file-tree-container";
  var FILE_TREE_STYLE_ATTRIBUTE = "data-file-tree-style";
  var FILE_TREE_UNSAFE_CSS_ATTRIBUTE = "data-file-tree-unsafe-css";
  var FILE_TREE_SCROLLBAR_MEASURE_ATTRIBUTE = "data-file-tree-scrollbar-measure";
  var FILE_TREE_SCROLLBAR_GUTTER_STYLE_ATTRIBUTE = "data-file-tree-scrollbar-gutter-measured";
  var FILE_TREE_SCROLLBAR_GUTTER_MEASURED_PROPERTY = "--trees-scrollbar-gutter-measured";
  var HEADER_SLOT_NAME = "header";
  var CONTEXT_MENU_SLOT_NAME = "context-menu";
  var CONTEXT_MENU_TRIGGER_TYPE = "context-menu-trigger";

  // node_modules/@pierre/trees/dist/iconConfig.js
  ...
  // node_modules/@pierre/trees/dist/render/iconResolver.js
  var normalizeIconRuleKey = (value) => value.trim().toLowerCase();
  var getBaseFileName = (path) => {
    return path.split("/").at(-1) ?? path;
  };
  var getExtensionCandidates = (fileName) => {
      ...
      if (name === "file-tree-icon-file" && filePath != null) {
        ...
        if (builtInToken != null && normalizedIcons.set !== "none") {
          if (builtInToken === "default") {
            const remappedEntry2 = iconRemap?.[name];
            if (remappedEntry2 != null) return remapEntryToIcon(remappedEntry2, name);
          }
          return {
  ...
  var PATH_STORE_CHILD_INDEX_CHUNK_THRESHOLD = PATH_STORE_CHILD_INDEX_CHUNK_SIZE * 4;
  ...
  function ensureChildPositions(index) {
    ...
    for (let i3 = 0; i3 < index.childIds.length; i3++) {
      const childId = index.childIds[i3];
      if (childId != null) positions.set(childId, i3);
    }
  ...
  function selectChildIndexByVisibleIndex(nodes, index, visibleIndex) {
    ...
    if (chunkSums != null) {
      let remainingIndex2 = visibleIndex;
      let childIndex = 0;
      for (const chunkVisibleCount of chunkSums) {
        if (remainingIndex2 < chunkVisibleCount) {
          const selected = selectChildIndexWithinChunk(nodes, index, childIndex, remainingIndex2);
          return {
            ...selected,
            childVisibleIndex: visibleIndex - selected.localVisibleIndex
          };
        }
        remainingIndex2 -= chunkVisibleCount;
  ...
  // node_modules/@pierre/trees/dist/path-store/src/internal-types.js
  var PATH_STORE_NODE_FLAGS_MASK = 7;
  var PATH_STORE_NODE_KIND_SHIFT = 3;
  var PATH_STORE_NODE_KIND_MASK = 1 << PATH_STORE_NODE_KIND_SHIFT;
  var PATH_STORE_NODE_DEPTH_SHIFT = 4;
  function createNodeDepthAndFlags(depth, flags, kind = 0) {
  ...
  // node_modules/@pierre/trees/dist/path-store/src/internal/benchmarkInstrumentation.js
  var BENCHMARK_INSTRUMENTATION = /* @__PURE__ */ Symbol("benchmarkInstrumentation");
  ...
  // node_modules/@pierre/trees/dist/path-store/src/sort.js
  ...
  function comparePreparedEntries(left, right) {
    ...
    for (let depth = 0; depth < sharedDepth; depth++) {
      ...
      if (leftKind !== getKindAtDepth(right, depth)) return leftKind === 1 ? -1 : 1;
  ...
  // node_modules/@pierre/trees/dist/path-store/src/options.js
  ...
  // node_modules/@pierre/trees/dist/path-store/src/path.js
  ...
  // node_modules/@pierre/trees/dist/path-store/src/segments.js
  function createSegmentTable() {
    ...
    return {
      idByValue,
      valueById: [""],
      sortKeyById: [createSegmentSortKey("")]
    };
  }
  ...
  // node_modules/@pierre/trees/dist/path-store/src/builder.js
  var PREPARED_INPUT_KIND = /* @__PURE__ */ Symbol("pathStorePreparedInputKind");
  ...
  function createRootNode() {
    return {
      depthAndFlags: createNodeDepthAndFlags(0, 3, 1),
      nameId: 0,
      parentId: 0,
      subtreeNodeCount: 1,
  ...
  var PathStoreBuilder = class {
      ...
      withBenchmarkPhase(this.instrumentation, "store.builder.appendPresortedPaths", () => {
        ...
        for (const path of paths) {
          ...
          while (slashPos >= 0 && slashPos < endIndex) {
            ...
            nodes.push({
              depthAndFlags: createNodeDepthAndFlags(currentDepth, 0, 1),
              nameId: dirNameId,
              parentId,
              subtreeNodeCount: 1,
              visibleSubtreeCount: 1
    ...
    appendPresortedFilePaths(paths) {
      ...
      for (const path of paths) {
        ...
        let slashPos = path.indexOf("/", segmentStart);
        while (slashPos >= 0) {
          const parentId2 = dirStack[stackTop];
          if (parentId2 === void 0) throw new Error("Directory stack underflow while building the path store");
          currentDepth++;
          const dirSeg = path.slice(segmentStart, slashPos);
          let dirNameId = idByValue.get(dirSeg);
          if (dirNameId === void 0) {
    ...
    appendPreparedPath(preparedPath, validateOrder) {
      ...
      for (let segmentIndex = sharedDirectoryDepth; segmentIndex < currentDirectoryDepth; segmentIndex++) {
        const parentId2 = this.directoryStack[this.directoryStack.length - 1];
        if (parentId2 === void 0) throw new Error("Directory stack underflow while building the path store");
        const childId = validateOrder ? this.getOrCreateDirectoryChild(parentId2, preparedPath.segments[segmentIndex]) : this.createDirectoryChild(parentId2, preparedPath.segments[segmentIndex]);
    ...
    getOrCreateDirectoryChild(parentId, segment) {
      ...
      const nodeId = this.nodes.length;
      this.nodes.push({
        depthAndFlags: createNodeDepthAndFlags(getNodeDepth(parentNode) + 1, 0, 1),
        nameId,
        parentId,
        subtreeNodeCount: 1,
        visibleSubtreeCount: 1
    ...
    promoteDirectoryToExplicit(directoryId, path) {
      ...
      if (hasNodeFlag(directoryNode, 1)) throw new Error(`Duplicate path: "${path}"`);
      addNodeFlag(directoryNode, 1);
    }
  ...
  // node_modules/@pierre/trees/dist/path-store/src/state.js
  ...
  function isDirectoryExpandedByDefault(state, node) {
    if (hasNodeFlag(node, 2)) return true;
  ...
  // node_modules/@pierre/trees/dist/path-store/src/events.js
  ...
  function finishTransaction(state, frame, emit, visibleCountDelta = null) {
    ...
    if (parentFrame != null) {
      const instrumentation2 = state.instrumentation;
      if (instrumentation2 == null) mergeBatchFrameIntoParent(parentFrame, frame);
      else withBenchmarkPhase(instrumentation2, "store.events.batch.merge", () => mergeBatchFrameIntoParent(parentFrame, frame));
      return;
    }
  ...
  // node_modules/@pierre/trees/dist/path-store/src/flatten.js
  ...
  // node_modules/@pierre/trees/dist/path-store/src/canonical.js
  ...
  function addPath(state, path) {
    ...
    if (preparedPath.isDirectory) {
      ...
      if (hasNodeFlag(directoryNode, 1)) throw new Error(`Path already exists: "${path}"`);
      addNodeFlag(directoryNode, 1);
  ...
  function removePath(state, path, options) {
    ...
    if (hasNodeFlag(node, 2)) throw new Error("The root node cannot be removed");
  ...
  function movePath(state, fromPath, toPath, options) {
    ...
    if (hasNodeFlag(sourceNode, 2)) throw new Error("The root node cannot be moved");
  ...
  function materializeNodePath(state, nodeId) {
    ...
    if (hasNodeFlag(node, 2)) return setCachedNodePath(state, nodeId, "");
  ...
  function requireNode(state, nodeId) {
    ...
    if (node === void 0 || hasNodeFlag(node, 4)) throw new Error(`Unknown node ID: ${String(nodeId)}`);
    return node;
  }
  function collectCanonicalEntries(state, nodeId) {
    const rootNode = state.snapshot.nodes[nodeId];
    if (rootNode === void 0 || hasNodeFlag(rootNode, 4)) return [];
    if (!isDirectoryNode(rootNode)) return [materializeNodePath(state, nodeId)];
    if (getDirectoryIndex(state, nodeId).childIds.length === 0) return hasNodeFlag(rootNode, 1) && !hasNodeFlag(rootNode, 2) ? [materializeNodePath(state, nodeId)] : [];
    const entries = [];
    const stack = [{
      childIndex: 0,
      nodeId
    ...
    while (stack.length > 0) {
      ...
      if (currentNode === void 0 || hasNodeFlag(currentNode, 4)) {
        stack.pop();
        continue;
      }
      ...
      if (currentIndex.childIds.length === 0) {
        if (hasNodeFlag(currentNode, 1) && !hasNodeFlag(currentNode, 2)) entries.push(materializeNodePath(state, frame.nodeId));
        stack.pop();
        continue;
      }
  ...
  function compareSiblingNodes(state, leftId, rightId) {
    ...
    return sortOption(createCompareEntry2(state, leftId), createCompareEntry2(state, rightId));
  }
  ...
  function createCompareEntry2(state, nodeId) {
    const node = requireNode(state, nodeId);
  ...
  function promoteEmptyAncestorsToExplicit(state, startDirectoryId) {
    ...
    while (currentDirectoryId != null) {
      ...
      if (!isDirectoryNode(currentNode) || hasNodeFlag(currentNode, 2)) return;
      if (getDirectoryIndex(state, currentDirectoryId).childIds.length > 0) return;
      addNodeFlag(currentNode, 1);
  ...
  function findNearestCollapsedAncestor(state, startDirectoryId) {
    ...
    while (currentDirectoryId != null) {
      const currentNode = requireNode(state, currentDirectoryId);
      if (!isDirectoryNode(currentNode) || hasNodeFlag(currentNode, 2)) return null;
  ...
  // node_modules/@pierre/trees/dist/path-store/src/cleanup.js
  function isLiveNode(node) {
    return node != null && !hasNodeFlag(node, 4);
  }
  function isLiveDirectoryNode(state, nodeId) {
    const node = state.snapshot.nodes[nodeId];
    if (!isLiveNode(node) || !isDirectoryNode(node) || hasNodeFlag(node, 2)) return null;
    return node;
  }
  ...
  // node_modules/@pierre/trees/dist/path-store/src/projection.js
  var INITIAL_PROJECTION_DEPTH_CAPACITY = 64;
  ...
  function getVisibleSlice(state, start, end) {
    ...
    if (instrumentation == null) {
      ...
      const rows2 = [];
      let currentCursor2 = selectVisibleRow(state, normalizedStart);
      for (let visibleIndex = normalizedStart; visibleIndex <= normalizedEnd && currentCursor2 != null; visibleIndex++) {
        const row = materializeVisibleRow(state, currentCursor2);
        rows2.push(row);
        currentCursor2 = getNextVisibleRowCursor(state, currentCursor2);
      }
      return rows2;
    }
    const rows = [];
  ...
  // node_modules/@pierre/trees/dist/path-store/src/soa-node-store.js
  var KIND_MASK = 8;
  function buildSoaNodeStore(snapshot) {
    ...
    let totalChildren = 0;
    for (const index of directories.values()) totalChildren += index.childIds.length;
  ...
  function sweepOpenVisibleCountsSoa(store) {
    ...
    for (let id = nodeCount - 1; id >= 1; id -= 1) {
      ...
      if (flattenEmptyDirectories && count === 1) newVisibleSubtreeCount = (depthAndFlags[childIdsFlat[base]] & KIND_MASK) !== 0 ? totalChildVisibleSubtreeCount : 1 + totalChildVisibleSubtreeCount;
  ...
  // node_modules/@pierre/trees/dist/path-store/src/store.js
  function initializeOpenVisibleCounts(state) {
    ...
    const walkDirectory = (nodeId) => {
      ...
      if (childCount >= 128) rebuildVisibleChildChunks(nodes, currentIndex);
    ...
    if (presortedDirectoryNodeIds != null) for (let i3 = presortedDirectoryNodeIds.length - 1; i3 >= 0; i3--) walkDirectory(presortedDirectoryNodeIds[i3]);
  ...
  function initializeOpenVisibleCountsViaSoa(state) {
    ...
    for (const [dirId, currentIndex] of directories) {
      ...
      currentIndex.totalChildSubtreeNodeCount = totalChildSubtreeNodeCount;
      currentIndex.totalChildVisibleSubtreeCount = totalChildVisibleSubtreeCount;
      if (dirId === rootId || childCount >= 128) rebuildVisibleChildChunks(nodes, currentIndex);
    }
  }
  ...
  var PathStore = class PathStore2 {
    ...
    constructor(options = {}) {
      ...
      if (useExplicitOpenExpansionFastPath || canInitializeOpenVisibleCounts(options) || (options.initialExpansion ?? "closed") === "closed" && expandedDirectoryCount === this.#state.snapshot.directories.size - 1 || (options.initialExpandedPaths?.length ?? 0) > 0 && withBenchmarkPhase(instrumentation, "store.state.checkAllDirectoriesExpanded", () => this.hasAllDirectoriesExpanded())) if (options.useSoaCountSweep === true) withBenchmarkPhase(instrumentation, "store.state.initializeOpenVisibleCountsViaSoa", () => initializeOpenVisibleCountsViaSoa(this.#state));
      else withBenchmarkPhase(instrumentation, "store.state.initializeOpenVisibleCounts", () => initializeOpenVisibleCounts(this.#state));
    ...
    initializeExpandedPaths(expandedPaths) {
      ...
      for (const path of expandedPaths) {
        ...
        while (segmentStart <= endIndex) {
          ...
          const searchForSegment = (startIndex, endIndex2) => {
            for (nextChildOffset = startIndex; nextChildOffset < endIndex2; nextChildOffset += 1) {
  ...
  // node_modules/@pierre/trees/dist/model/density.js
  var FILE_TREE_DENSITY_PRESETS = {
    compact: {
      itemHeight: 24,
      factor: 0.8
    },
  ...
  // node_modules/@pierre/trees/dist/model/virtualization.js
  var FILE_TREE_DEFAULT_ITEM_HEIGHT = FILE_TREE_DENSITY_PRESETS.default.itemHeight;

  // node_modules/@pierre/trees/dist/style.js
  ...
  // node_modules/@pierre/trees/dist/utils/cssWrappers.js
  var LAYER_ORDER = `@layer base, unsafe;`;
...
@layer unsafe {
  ...
  // node_modules/@pierre/trees/dist/utils/scrollbarGutter.js
  var measuredGutterCache = /* @__PURE__ */ new WeakMap();
  ...
  // node_modules/@pierre/trees/dist/components/web-components.js
  var sheet;
  function ensureFileTreeStyles(shadowRoot) {
    ...
    if (shadowRoot.querySelector(`style[data-file-tree-style]`) == null) {
  ...
  if (typeof HTMLElement !== "undefined" && customElements.get("file-tree-container") == null) {
  ...
  // node_modules/@pierre/trees/dist/utils/getSelectionPath.js
  var getSelectionPath = (path) => path.startsWith("f::") ? path.slice(3) : path;

  // node_modules/@pierre/trees/dist/utils/renameFileTreePaths.js
  ...
  function renameFileTreePaths({ files, path, isFolder, nextBasename }) {
    ...
    if (!isFolder) {
      const destinationPrefix2 = `${destinationPath}/`;
      let renamed = false;
      for (let index = 0; index < files.length; index++) {
        const file = files[index];
        if (file !== sourcePath && file.startsWith(destinationPrefix2)) return { error: `"${destinationPath}" already exists.` };
  ...
  // node_modules/@pierre/trees/dist/model/dragAndDrop.js
  ...
  // node_modules/@pierre/trees/dist/model/inputResolution.js
  ...
  // node_modules/@pierre/trees/dist/model/mutationEvents.js
  ...
  // node_modules/@pierre/trees/dist/model/pathHelpers.js
  ...
  function getAncestorDirectoryPaths(path) {
    ...
    return segments.slice(0, -1).map((_3, index) => `${segments.slice(0, index + 1).join("/")}/`);
  }
  ...
  function isCanonicalDirectoryPath2(path) {
    return path.endsWith("/");
  }
  var toLowerCaseSearchPath = (path) => path.toLowerCase();

  // node_modules/@pierre/trees/dist/model/renameHelpers.js
  ...
  // node_modules/@pierre/trees/dist/model/searchHelpers.js
  var normalizeSearchQuery = (value) => {
    const trimmedValue = value.trim();
    if (trimmedValue.length === 0) return "";
    return (trimmedValue.includes("\\") ? trimmedValue.replaceAll("\\", "/") : trimmedValue).toLowerCase();
  };

  // node_modules/@pierre/trees/dist/model/FileTreeController.js
  var FILE_TREE_RENAME_VIEW = /* @__PURE__ */ Symbol("FILE_TREE_RENAME_VIEW");
  var INITIAL_PROJECTION_ROW_LIMIT = 512;
  var CONTEXT_VISIBLE_ROW_RANGE_LIMIT = 512;
  ...
  var _baseOptions, _listeners, _mutationListeners, _dragAndDropConfig, _dragSession, _ancestorIndicesByIndex, _ancestorPathsByIndex, _focusedIndex, _focusedPath, _hasFullProjection, _getParentIndexForVisibleRow, _itemHandles, _knownDirectoryPaths, _knownDirectoryPathsLowerCase, _knownPaths, _listedPaths, _listedPathsLowerCase, _onRename, _onRenameError, _onSearchChange, _projectionPaths, _projectionPosInSetByIndex, _projectionSetSizeByIndex, _renameCanRename, _renameEnabled, _renamingPath, _renamingValue, _removeRenamingPathIfCanceled, _searchMatchPathSet, _searchMatchingPaths, _searchMode, _searchPreviousExpandedPaths, _searchValue, _searchVisiblePathSet, _searchVisibleIndexByPath, _searchVisibleIndices, _searchVisiblePaths, _scrollRequest, _scrollRequestId, _selectionAnchorPath, _selectedPaths, _selectionVersion, _store, _storeVisibleCount, _suppressStoreNotifications, _visibleCount, _unsubscribe, _FileTreeController_instances, cancelRenaming_fn, completeRenaming_fn, setRenamingValue_fn, findNearestVisibleSiblingPath_fn, resolveFocusedIndex_fn, getOrCreateItemHandle_fn, createVisibleRow_fn, createVisibleRowFromContext_fn, getStickyCandidateContextAt_fn, getAncestorIndices_fn, getAncestorPaths_fn, collapseDirectory_fn, applySelection_fn, createDirectoryHandle_fn, createFileHandle_fn, validateBatchDropOperations_fn, createStore_fn, getListedPaths_fn, getAllKnownPaths_fn, getListedPathsLowerCase_fn, getAllKnownDirectoryPaths_fn, getAllKnownDirectoryPathsLowerCase_fn, invalidateKnownPathCaches_fn, getExpandedDirectoryPaths_fn, restoreSearchExpandedPaths_fn, setExpandedPaths_fn, syncSearchVisibilityState_fn, getCurrentVisiblePaths_fn, getExactCurrentVisibleIndexByPath_fn, getProjectionIndexFromVisibleIndex_fn, getVisibleIndexByPath_fn, focusRelativeSearchMatch_fn, setSearchState_fn, refreshActiveSearchState_fn, emit_fn, emitMutation_fn, expandDirectory_fn, moveFocus_fn, rebuildVisibleProjection_fn, resolveVisiblePathAtIndex_fn, resolveSelectionPath_fn, focusPathWithoutEmit_fn, setFocusedIndex_fn, ensureFullProjection_fn, applyMutationState_fn, subscribe_fn, toggleDirectory_fn, _a;
  var FileTreeController = (_a = class {
    constructor(options) {
      __privateAdd(this, _FileTreeController_instances);
      __privateAdd(this, _baseOptions);
      __privateAdd(this, _listeners, /* @__PURE__ */ new Set());
      __privateAdd(this, _mutationListeners, /* @__PURE__ */ new Map());
      __privateAdd(this, _dragAndDropConfig, null);
      __privateAdd(this, _dragSession, null);
      __privateAdd(this, _ancestorIndicesByIndex, /* @__PURE__ */ new Map());
      __privateAdd(this, _ancestorPathsByIndex, /* @__PURE__ */ new Map());
      __privateAdd(this, _focusedIndex, -1);
      __privateAdd(this, _focusedPath, null);
      __privateAdd(this, _hasFullProjection, false);
      __privateAdd(this, _getParentIndexForVisibleRow, (_index) => -1);
      __privateAdd(this, _itemHandles, /* @__PURE__ */ new Map());
      __privateAdd(this, _knownDirectoryPaths, null);
      __privateAdd(this, _knownDirectoryPathsLowerCase, null);
      __privateAdd(this, _knownPaths, null);
      __privateAdd(this, _listedPaths, null);
      __privateAdd(this, _listedPathsLowerCase, null);
      __privateAdd(this, _onRename);
      __privateAdd(this, _onRenameError);
      __privateAdd(this, _onSearchChange);
      __privateAdd(this, _projectionPaths, []);
      __privateAdd(this, _projectionPosInSetByIndex, /* @__PURE__ */ new Int32Array(0));
      __privateAdd(this, _projectionSetSizeByIndex, /* @__PURE__ */ new Int32Array(0));
      __privateAdd(this, _renameCanRename);
      __privateAdd(this, _renameEnabled, false);
      __privateAdd(this, _renamingPath, null);
      __privateAdd(this, _renamingValue, "");
      __privateAdd(this, _removeRenamingPathIfCanceled, false);
      __privateAdd(this, _searchMatchPathSet, /* @__PURE__ */ new Set());
      __privateAdd(this, _searchMatchingPaths, []);
      __privateAdd(this, _searchMode);
      __privateAdd(this, _searchPreviousExpandedPaths, null);
      __privateAdd(this, _searchValue, null);
      __privateAdd(this, _searchVisiblePathSet, null);
      __privateAdd(this, _searchVisibleIndexByPath, null);
      __privateAdd(this, _searchVisibleIndices, null);
      __privateAdd(this, _searchVisiblePaths, null);
      __privateAdd(this, _scrollRequest, null);
      __privateAdd(this, _scrollRequestId, 0);
      __privateAdd(this, _selectionAnchorPath, null);
      __privateAdd(this, _selectedPaths, /* @__PURE__ */ new Set());
      __privateAdd(this, _selectionVersion, 0);
      __privateAdd(this, _store);
      __privateAdd(this, _storeVisibleCount, 0);
      __privateAdd(this, _suppressStoreNotifications, false);
      __privateAdd(this, _visibleCount, 0);
      ...
      if (dragAndDrop != null && dragAndDrop !== false) __privateSet(this, _dragAndDropConfig, dragAndDrop === true ? {} : dragAndDrop);
      __privateSet(this, _renameEnabled, renaming != null && renaming !== false);
      if (renaming != null && renaming !== false && renaming !== true) {
        __privateSet(this, _renameCanRename, renaming.canRename);
        __privateSet(this, _onRenameError, renaming.onError);
        __privateSet(this, _onRename, renaming.onRename);
      }
      __privateSet(this, _onSearchChange, onSearchChange);
      __privateSet(this, _searchMode, fileTreeSearchMode ?? "hide-non-matches");
      __privateSet(this, _store, __privateMethod(this, _FileTreeController_instances, createStore_fn).call(this, resolvedInput.paths, resolvedInput.preparedInput));
      const resolvedInitialSelectedPaths = initialSelectedPaths?.map((path) => __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path)).filter((resolved) => resolved != null) ?? [];
      const initialFocusedPath = resolvedInitialSelectedPaths.at(-1) ?? null;
      if (resolvedInitialSelectedPaths.length > 0) {
        __privateSet(this, _selectedPaths, new Set(resolvedInitialSelectedPaths));
        __privateSet(this, _selectionAnchorPath, initialFocusedPath);
        __privateSet(this, _selectionVersion, 1);
      }
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, initialFocusedPath, false);
      if (initialSearchQuery != null) __privateMethod(this, _FileTreeController_instances, setSearchState_fn).call(this, initialSearchQuery, false);
      __privateSet(this, _unsubscribe, __privateMethod(this, _FileTreeController_instances, subscribe_fn).call(this));
    }
    destroy() {
      var _a2;
      (_a2 = __privateGet(this, _unsubscribe)) == null ? void 0 : _a2.call(this);
      __privateSet(this, _unsubscribe, null);
      __privateGet(this, _mutationListeners).clear();
      __privateGet(this, _listeners).clear();
      __privateGet(this, _itemHandles).clear();
      __privateSet(this, _dragSession, null);
      __privateMethod(this, _FileTreeController_instances, invalidateKnownPathCaches_fn).call(this);
    }
    focusFirstItem() {
      if (__privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this).length > 0) __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, 0);
    }
    focusLastItem() {
      if (__privateGet(this, _visibleCount) <= 0) return;
      __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, __privateGet(this, _visibleCount) - 1);
    }
    focusNextItem() {
      __privateMethod(this, _FileTreeController_instances, moveFocus_fn).call(this, 1);
    }
    focusParentItem() {
      if (__privateGet(this, _focusedPath) == null) return;
      const parentPath = getImmediateParentPath(__privateGet(this, _focusedPath));
      if (parentPath == null) return;
      const nextFocusedIndex = __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, parentPath);
      if (nextFocusedIndex >= 0) __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextFocusedIndex);
    }
    focusPath(path) {
      const resolvedPath = __privateGet(this, _store).getPathInfo(path)?.path ?? null;
      if (resolvedPath == null) return;
      __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      const nextFocusedIndex = __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, resolvedPath);
      if (nextFocusedIndex >= 0) __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextFocusedIndex);
    }
    scrollToPath(path, options) {
      ...
      if (resolvedPath == null) return;
      __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      const targetIndex = __privateMethod(this, _FileTreeController_instances, getExactCurrentVisibleIndexByPath_fn).call(this, resolvedPath);
      if (targetIndex < 0) return;
      if (__privateMethod(this, _FileTreeController_instances, resolveVisiblePathAtIndex_fn).call(this, targetIndex) == null) return;
      if (options?.focus !== false) __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, targetIndex, false);
      __privateSet(this, _scrollRequest, {
        id: __privateSet(this, _scrollRequestId, __privateGet(this, _scrollRequestId) + 1),
        offset: normalizeScrollOffset(options?.offset),
        visibleIndex: targetIndex
      });
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
    }
    ...
    focusNearestPath(path) {
      ...
      if (nextPath == null) return null;
      const nextFocusedIndex = __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, nextPath);
      if (nextFocusedIndex >= 0) {
        __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextFocusedIndex);
        return __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this)[nextFocusedIndex] ?? nextPath;
      }
      return null;
    }
    focusPreviousItem() {
    ...
    getFocusedIndex() {
      return __privateGet(this, _focusedIndex);
    }
    getFocusedItem() {
      return __privateGet(this, _focusedPath) == null ? null : __privateMethod(this, _FileTreeController_instances, getOrCreateItemHandle_fn).call(this, __privateGet(this, _focusedPath));
    }
    getFocusedPath() {
      return __privateGet(this, _focusedPath);
    }
    getScrollRequest() {
      return __privateGet(this, _scrollRequest);
    }
    clearScrollRequest(id) {
      if (__privateGet(this, _scrollRequest)?.id === id) __privateSet(this, _scrollRequest, null);
    }
    resolveNearestVisiblePath(path) {
      const currentVisiblePaths = __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this);
      if (__privateGet(this, _visibleCount) === 0) return null;
      if (path == null) return __privateGet(this, _focusedPath) ?? currentVisiblePaths[0] ?? null;
      const resolvedPath = __privateGet(this, _store).getPathInfo(path)?.path ?? path;
      const directIndex = __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, resolvedPath);
      if (directIndex >= 0) return currentVisiblePaths[directIndex] ?? resolvedPath;
      const siblingPath = __privateMethod(this, _FileTreeController_instances, findNearestVisibleSiblingPath_fn).call(this, resolvedPath);
      if (siblingPath != null) return siblingPath;
      return __privateGet(this, _focusedPath) ?? currentVisiblePaths[0] ?? null;
    }
    getSelectedPaths() {
      return [...__privateGet(this, _selectedPaths)];
    }
    getSelectionVersion() {
      return __privateGet(this, _selectionVersion);
    }
    getVisibleCount() {
      return __privateGet(this, _visibleCount);
    }
    getVisibleRows(start, end) {
      if (end < start || __privateGet(this, _visibleCount) === 0) return [];
      const boundedStart = Math.max(0, start);
      const boundedEnd = Math.min(__privateGet(this, _visibleCount) - 1, end);
      if (boundedEnd < boundedStart) return [];
      const boundedLength = boundedEnd - boundedStart + 1;
      if (__privateGet(this, _searchVisibleIndices) == null && !__privateGet(this, _hasFullProjection) && boundedEnd >= __privateGet(this, _projectionPaths).length && boundedLength <= CONTEXT_VISIBLE_ROW_RANGE_LIMIT) {
        const rows = [];
        for (let index = boundedStart; index <= boundedEnd; index += 1) {
          const context = __privateGet(this, _store).getVisibleRowContext(index);
          if (context == null) break;
          rows.push(__privateMethod(this, _FileTreeController_instances, createVisibleRowFromContext_fn).call(this, context));
        }
        return rows;
      }
      if (!__privateGet(this, _hasFullProjection) && boundedEnd >= __privateGet(this, _projectionPaths).length) __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      if (__privateGet(this, _searchVisibleIndices) != null) {
        const projectionIndices = Array.from({ length: boundedEnd - boundedStart + 1 }, (_3, visibleOffset) => __privateMethod(this, _FileTreeController_instances, getProjectionIndexFromVisibleIndex_fn).call(this, boundedStart + visibleOffset));
        ...
        for (let index = 1; index <= projectionIndices.length; index += 1) {
          ...
          if (runStartIndex >= 0) __privateGet(this, _store).getVisibleSlice(runStartIndex, runEndIndex).forEach((row, offset) => {
        ...
        return Array.from({ length: boundedEnd - boundedStart + 1 }, (_3, visibleOffset) => {
          const visibleIndex = boundedStart + visibleOffset;
          const projectionIndex = __privateMethod(this, _FileTreeController_instances, getProjectionIndexFromVisibleIndex_fn).call(this, visibleIndex);
          const row = visibleRowByProjectionIndex.get(projectionIndex);
          const projectionPath = __privateGet(this, _projectionPaths)[projectionIndex];
          if (row == null || projectionPath == null) throw new Error(`Missing projection row for filtered visible index ${String(visibleIndex)}`);
          return __privateMethod(this, _FileTreeController_instances, createVisibleRow_fn).call(this, row, visibleIndex, projectionIndex, {
            ancestorPaths: __privateMethod(this, _FileTreeController_instances, getAncestorPaths_fn).call(this, projectionIndex),
            path: projectionPath
          });
        });
      }
      return __privateGet(this, _store).getVisibleSlice(boundedStart, boundedEnd).map((row, offset) => {
        const index = boundedStart + offset;
        const projectionPath = __privateGet(this, _projectionPaths)[index];
        if (projectionPath == null) throw new Error(`Missing projection path for visible index ${String(index)}`);
        return __privateMethod(this, _FileTreeController_instances, createVisibleRow_fn).call(this, row, index, index, {
          ancestorPaths: __privateMethod(this, _FileTreeController_instances, getAncestorPaths_fn).call(this, index),
          path: projectionPath
        });
      });
    }
    getStickyRowCandidates(scrollTop, itemHeight) {
      if (__privateGet(this, _searchVisibleIndices) != null) return null;
      if (__privateGet(this, _visibleCount) === 0 || scrollTop <= 0 || itemHeight <= 0) return [];
      const stickyRows = [];
      for (let slotDepth = 0; slotDepth < __privateGet(this, _visibleCount); slotDepth += 1) {
        const slotTop = scrollTop + slotDepth * itemHeight;
        const thresholdIndex = Math.min(__privateGet(this, _visibleCount) - 1, Math.floor(slotTop / itemHeight));
        const candidateContext = __privateMethod(this, _FileTreeController_instances, getStickyCandidateContextAt_fn).call(this, thresholdIndex, slotDepth) ?? (thresholdIndex > 0 ? __privateMethod(this, _FileTreeController_instances, getStickyCandidateContextAt_fn).call(this, thresholdIndex - 1, slotDepth) : void 0);
        if (candidateContext == null) break;
        stickyRows.push({
          row: __privateMethod(this, _FileTreeController_instances, createVisibleRowFromContext_fn).call(this, candidateContext),
    ...
    */
    getItem(path) {
      const itemInfo = __privateGet(this, _store).getPathInfo(path);
      return itemInfo == null ? null : __privateMethod(this, _FileTreeController_instances, getOrCreateItemHandle_fn).call(this, itemInfo.path, itemInfo);
    }
    resolveMountedDirectoryPathFromInput(path) {
      const pathInfo = __privateGet(this, _store).getPathInfo(path);
    ...
    toggleMountedDirectoryFromInput(path) {
      ...
      __privateMethod(this, _FileTreeController_instances, toggleDirectory_fn).call(this, directoryPath);
    }
    selectAllVisiblePaths() {
      __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      const nextSelectedPaths = [...__privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this)];
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, nextSelectedPaths, __privateGet(this, _focusedPath) ?? __privateGet(this, _selectionAnchorPath));
    }
    selectOnlyPath(path) {
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null) return;
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [resolvedPath], resolvedPath);
    }
    selectOnlyMountedPathFromInput(path) {
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [path], path);
    }
    selectPath(path) {
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null || __privateGet(this, _selectedPaths).has(resolvedPath)) return;
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [...__privateGet(this, _selectedPaths), resolvedPath]);
    }
    deselectPath(path) {
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null || !__privateGet(this, _selectedPaths).has(resolvedPath)) return;
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [...__privateGet(this, _selectedPaths)].filter((selectedPath) => selectedPath !== resolvedPath));
    }
    toggleFocusedSelection() {
      if (__privateGet(this, _focusedPath) == null) return;
      this.togglePathSelectionFromInput(__privateGet(this, _focusedPath));
    }
    togglePathSelection(path) {
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null) return;
      if (__privateGet(this, _selectedPaths).has(resolvedPath)) {
    ...
    togglePathSelectionFromInput(path) {
      ...
      if (resolvedPath == null) return;
      if (__privateGet(this, _selectedPaths).has(resolvedPath)) {
        __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [...__privateGet(this, _selectedPaths)].filter((selectedPath) => selectedPath !== resolvedPath), resolvedPath);
        return;
      }
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [...__privateGet(this, _selectedPaths), resolvedPath], resolvedPath);
    }
    selectPathRange(path, unionSelection) {
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null) return;
      __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      const anchorPath = __privateGet(this, _selectionAnchorPath);
      const anchorIndex = anchorPath == null ? -1 : __privateMethod(this, _FileTreeController_instances, getVisibleIndexByPath_fn).call(this, anchorPath);
      const targetIndex = __privateMethod(this, _FileTreeController_instances, getVisibleIndexByPath_fn).call(this, resolvedPath);
      if (anchorIndex === -1 || targetIndex === -1) {
        const nextSelectedPaths2 = unionSelection ? [...__privateGet(this, _selectedPaths), resolvedPath] : [resolvedPath];
        __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, nextSelectedPaths2, resolvedPath);
        return;
      }
      const [startIndex, endIndex] = anchorIndex <= targetIndex ? [anchorIndex, targetIndex] : [targetIndex, anchorIndex];
      const rangePaths = __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this).slice(startIndex, endIndex + 1);
      const nextSelectedPaths = unionSelection ? [...__privateGet(this, _selectedPaths), ...rangePaths] : rangePaths;
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, nextSelectedPaths, anchorPath);
    }
    extendSelectionFromFocused(offset) {
      if (__privateGet(this, _focusedPath) == null) return;
      const focusedIndex = __privateGet(this, _focusedIndex);
      if (focusedIndex === -1) return;
      const nextIndex = Math.min(__privateGet(this, _visibleCount) - 1, Math.max(0, focusedIndex + offset));
      if (nextIndex === focusedIndex) return;
      if (!__privateGet(this, _hasFullProjection) && nextIndex >= __privateGet(this, _projectionPaths).length) __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      const visiblePaths = __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this);
      ...
      const nextSelectedPaths = new Set(__privateGet(this, _selectedPaths));
      ...
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [...nextSelectedPaths], __privateGet(this, _selectionAnchorPath) ?? currentPath, false);
      __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextIndex);
    }
    getDragAndDropConfig() {
      return __privateGet(this, _dragAndDropConfig);
    }
    isDragAndDropEnabled() {
      return __privateGet(this, _dragAndDropConfig) != null;
    }
    getDragSession() {
      if (__privateGet(this, _dragSession) == null) return null;
      return {
        draggedPaths: [...__privateGet(this, _dragSession).draggedPaths],
        primaryPath: __privateGet(this, _dragSession).primaryPath,
        target: __privateGet(this, _dragSession).target == null ? null : { ...__privateGet(this, _dragSession).target }
      };
    }
    startDrag(path) {
      if (__privateGet(this, _dragAndDropConfig) == null) return false;
      const resolvedPath = __privateMethod(this, _FileTreeController_instances, resolveSelectionPath_fn).call(this, path);
      if (resolvedPath == null) return false;
      if (__privateGet(this, _searchValue) != null && __privateGet(this, _searchValue).length > 0) return false;
      const selectedPaths = this.getSelectedPaths();
      const draggedPaths = resolveDraggedPathsForStart(resolvedPath, selectedPaths);
      if (__privateGet(this, _dragAndDropConfig).canDrag?.(draggedPaths) === false) return false;
      if (!selectedPaths.includes(resolvedPath)) __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [resolvedPath], resolvedPath, false);
      __privateMethod(this, _FileTreeController_instances, focusPathWithoutEmit_fn).call(this, resolvedPath);
      __privateSet(this, _dragSession, {
        draggedPaths,
    ...
    setDragTarget(target) {
      const dragSession = __privateGet(this, _dragSession);
      if (dragSession == null) return;
      let nextTarget = target;
      if (nextTarget != null) {
        const context = createDropContext(dragSession.draggedPaths, nextTarget);
        if (isSelfOrDescendantDrop(dragSession.draggedPaths, nextTarget) || __privateGet(this, _dragAndDropConfig)?.canDrop?.(context) === false) nextTarget = null;
      }
    ...
    cancelDrag() {
      if (__privateGet(this, _dragSession) == null) return;
      __privateSet(this, _dragSession, null);
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
    }
    completeDrag() {
      ...
      if (isSelfOrDescendantDrop(dragSession.draggedPaths, target) || __privateGet(this, _dragAndDropConfig)?.canDrop?.(dropContext) === false) {
        __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
        return false;
      }
      ...
      try {
        if (dropPlan.operations.length === 1) {
          ...
          __privateGet(this, _store).move(singleOperation.from, singleOperation.to, { collision: singleOperation.collision });
        } else {
          __privateMethod(this, _FileTreeController_instances, validateBatchDropOperations_fn).call(this, dropPlan.operations);
          __privateGet(this, _store).batch(dropPlan.operations);
        }
      } catch (error) {
        __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
        __privateGet(this, _dragAndDropConfig)?.onDropError?.(error instanceof Error ? error.message : String(error), dropContext);
        return false;
      }
      __privateGet(this, _dragAndDropConfig)?.onDropComplete?.(dropPlan.result);
      return true;
    }
    subscribe(listener) {
    ...
    */
    add(path) {
      __privateGet(this, _store).add(path);
    }
    remove(path, options = {}) {
      __privateGet(this, _store).remove(path, options);
    }
    move(fromPath, toPath, options = {}) {
      __privateGet(this, _store).move(fromPath, toPath, options);
    }
    batch(operations) {
      __privateGet(this, _store).batch(operations);
    }
    onMutation(type, handler) {
      const key = type;
      const typedHandler = handler;
      let listenersForType = __privateGet(this, _mutationListeners).get(key);
      if (listenersForType == null) {
        listenersForType = /* @__PURE__ */ new Set();
        __privateGet(this, _mutationListeners).set(key, listenersForType);
      }
      listenersForType.add(typedHandler);
      return () => {
        const registeredListeners = __privateGet(this, _mutationListeners).get(key);
        registeredListeners?.delete(typedHandler);
        if (registeredListeners?.size === 0) __privateGet(this, _mutationListeners).delete(key);
      };
    }
    setSearch(value) {
      __privateMethod(this, _FileTreeController_instances, setSearchState_fn).call(this, value, true);
    }
    openSearch(initialValue = "") {
      __privateMethod(this, _FileTreeController_instances, setSearchState_fn).call(this, initialValue, true);
    }
    closeSearch() {
      __privateMethod(this, _FileTreeController_instances, setSearchState_fn).call(this, null, true);
    }
    isSearchOpen() {
      return __privateGet(this, _searchValue) !== null;
    }
    getSearchValue() {
      return __privateGet(this, _searchValue) ?? "";
    }
    getSearchMatchingPaths() {
      return __privateGet(this, _searchMatchingPaths);
    }
    focusNextSearchMatch() {
      __privateMethod(this, _FileTreeController_instances, focusRelativeSearchMatch_fn).call(this, 1);
    }
    focusPreviousSearchMatch() {
      __privateMethod(this, _FileTreeController_instances, focusRelativeSearchMatch_fn).call(this, -1);
    }
    startRenaming(path = __privateGet(this, _focusedPath) ?? "", options = {}) {
      var _a2, _b;
      if (!__privateGet(this, _renameEnabled)) return false;
      const itemInfo = __privateGet(this, _store).getPathInfo(path);
      if (itemInfo == null) return false;
      const canonicalPath = itemInfo.path;
      const isFolder = isCanonicalDirectoryPath2(canonicalPath);
      const publicPath = toRenameHelperPath(canonicalPath);
      if (((_a2 = __privateGet(this, _renameCanRename)) == null ? void 0 : _a2.call(this, {
        isFolder,
        path: publicPath
      })) === false) return false;
      for (const ancestorPath of getAncestorDirectoryPaths(canonicalPath)) if (!__privateGet(this, _store).isExpanded(ancestorPath)) __privateGet(this, _store).expand(ancestorPath);
      __privateMethod(this, _FileTreeController_instances, applySelection_fn).call(this, [canonicalPath], canonicalPath, false);
      if (__privateGet(this, _searchValue) != null) {
        __privateMethod(this, _FileTreeController_instances, setSearchState_fn).call(this, null, false);
        (_b = __privateGet(this, _onSearchChange)) == null ? void 0 : _b.call(this, __privateGet(this, _searchValue));
      }
      __privateMethod(this, _FileTreeController_instances, focusPathWithoutEmit_fn).call(this, canonicalPath);
      __privateSet(this, _renamingPath, canonicalPath);
      __privateSet(this, _renamingValue, getRenameLeafName(canonicalPath));
      __privateSet(this, _removeRenamingPathIfCanceled, options.removeIfCanceled ?? false);
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
      return true;
    }
    resetPaths(pathsOrOptions, maybeOptions = {}) {
      var _a2;
      const usingPreparedOnlyOverload = !Array.isArray(pathsOrOptions);
      const paths = usingPreparedOnlyOverload ? void 0 : pathsOrOptions;
      const options = usingPreparedOnlyOverload ? pathsOrOptions : maybeOptions;
      const previousPathCount = __privateGet(this, _store).list().length;
      const previousVisibleCount = __privateGet(this, _visibleCount);
      const resolvedInput = resolveFileTreeInput({
        paths,
        preparedInput: options.preparedInput
      }, "resetPaths", __privateGet(this, _baseOptions).sort);
      const nextStore = __privateMethod(this, _FileTreeController_instances, createStore_fn).call(this, resolvedInput.paths, resolvedInput.preparedInput, options.initialExpandedPaths);
      const previousFocusedPath = __privateGet(this, _focusedPath);
      const previousRenamingPath = __privateGet(this, _renamingPath);
      const previousSelectedPaths = this.getSelectedPaths();
      const previousSelectionAnchorPath = __privateGet(this, _selectionAnchorPath);
      (_a2 = __privateGet(this, _unsubscribe)) == null ? void 0 : _a2.call(this);
      __privateSet(this, _store, nextStore);
      __privateGet(this, _itemHandles).clear();
      __privateMethod(this, _FileTreeController_instances, invalidateKnownPathCaches_fn).call(this);
      ...
      const selectionChanged = !arePathSetsEqual(__privateGet(this, _selectedPaths), nextSelectedPaths);
      __privateSet(this, _selectedPaths, new Set(nextSelectedPaths));
      if (selectionChanged) __privateSet(this, _selectionVersion, __privateGet(this, _selectionVersion) + 1);
      __privateSet(this, _selectionAnchorPath, previousSelectionAnchorPath == null ? null : nextStore.getPathInfo(previousSelectionAnchorPath)?.path ?? null);
      __privateSet(this, _renamingPath, previousRenamingPath == null ? null : nextStore.getPathInfo(previousRenamingPath)?.path ?? null);
      if (__privateGet(this, _renamingPath) == null) {
        __privateSet(this, _renamingValue, "");
        __privateSet(this, _removeRenamingPathIfCanceled, false);
      }
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, previousFocusedPath, previousFocusedPath != null || nextSelectedPaths.length > 0 || __privateGet(this, _selectionAnchorPath) != null);
      __privateSet(this, _unsubscribe, __privateMethod(this, _FileTreeController_instances, subscribe_fn).call(this));
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
      __privateMethod(this, _FileTreeController_instances, emitMutation_fn).call(this, {
        canonicalChanged: true,
        operation: "reset",
        ...
        visibleCountDelta: __privateGet(this, _visibleCount) - previousVisibleCount
      });
    }
  }, _baseOptions = new WeakMap(), _listeners = new WeakMap(), _mutationListeners = new WeakMap(), _dragAndDropConfig = new WeakMap(), _dragSession = new WeakMap(), _ancestorIndicesByIndex = new WeakMap(), _ancestorPathsByIndex = new WeakMap(), _focusedIndex = new WeakMap(), _focusedPath = new WeakMap(), _hasFullProjection = new WeakMap(), _getParentIndexForVisibleRow = new WeakMap(), _itemHandles = new WeakMap(), _knownDirectoryPaths = new WeakMap(), _knownDirectoryPathsLowerCase = new WeakMap(), _knownPaths = new WeakMap(), _listedPaths = new WeakMap(), _listedPathsLowerCase = new WeakMap(), _onRename = new WeakMap(), _onRenameError = new WeakMap(), _onSearchChange = new WeakMap(), _projectionPaths = new WeakMap(), _projectionPosInSetByIndex = new WeakMap(), _projectionSetSizeByIndex = new WeakMap(), _renameCanRename = new WeakMap(), _renameEnabled = new WeakMap(), _renamingPath = new WeakMap(), _renamingValue = new WeakMap(), _removeRenamingPathIfCanceled = new WeakMap(), _searchMatchPathSet = new WeakMap(), _searchMatchingPaths = new WeakMap(), _searchMode = new WeakMap(), _searchPreviousExpandedPaths = new WeakMap(), _searchValue = new WeakMap(), _searchVisiblePathSet = new WeakMap(), _searchVisibleIndexByPath = new WeakMap(), _searchVisibleIndices = new WeakMap(), _searchVisiblePaths = new WeakMap(), _scrollRequest = new WeakMap(), _scrollRequestId = new WeakMap(), _selectionAnchorPath = new WeakMap(), _selectedPaths = new WeakMap(), _selectionVersion = new WeakMap(), _store = new WeakMap(), _storeVisibleCount = new WeakMap(), _suppressStoreNotifications = new WeakMap(), _visibleCount = new WeakMap(), _unsubscribe = new WeakMap(), _FileTreeController_instances = new WeakSet(), cancelRenaming_fn = function() {
    if (__privateGet(this, _renamingPath) == null) return;
    const renamingPath = __privateGet(this, _renamingPath);
    const removePlaceholderEntry = __privateGet(this, _removeRenamingPathIfCanceled);
    __privateSet(this, _renamingPath, null);
    __privateSet(this, _renamingValue, "");
    __privateSet(this, _removeRenamingPathIfCanceled, false);
    if (removePlaceholderEntry) {
      this.remove(renamingPath, isCanonicalDirectoryPath2(renamingPath) ? { recursive: true } : void 0);
      return;
    }
    __privateMethod(this, _FileTreeController_instances, focusPathWithoutEmit_fn).call(this, renamingPath);
    __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
  }, completeRenaming_fn = function() {
    var _a2, _b;
    const renamingPath = __privateGet(this, _renamingPath);
    if (renamingPath == null) return;
    if (__privateGet(this, _removeRenamingPathIfCanceled) && __privateGet(this, _renamingValue).trim().length === 0) {
      __privateSet(this, _renamingPath, null);
      __privateSet(this, _renamingValue, "");
      __privateSet(this, _removeRenamingPathIfCanceled, false);
      this.remove(renamingPath, isCanonicalDirectoryPath2(renamingPath) ? { recursive: true } : void 0);
    ...
    const isFolder = isCanonicalDirectoryPath2(renamingPath);
    const result = renameFileTreePaths({
      files: __privateGet(this, _store).list(),
      isFolder,
      nextBasename: __privateGet(this, _renamingValue),
    ...
    if ("error" in result) {
      __privateMethod(this, _FileTreeController_instances, focusPathWithoutEmit_fn).call(this, renamingPath);
      (_a2 = __privateGet(this, _onRenameError)) == null ? void 0 : _a2.call(this, result.error);
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
      return;
    }
    ...
    (_b = __privateGet(this, _onRename)) == null ? void 0 : _b.call(this, {
  ...
  }, setRenamingValue_fn = function(value) {
    if (__privateGet(this, _renamingPath) == null || __privateGet(this, _renamingValue) === value) return;
    __privateSet(this, _renamingValue, value);
    __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
  }, findNearestVisibleSiblingPath_fn = function(path) {
    __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
    ...
    for (const siblingPath of __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this)) {
  ...
  }, resolveFocusedIndex_fn = function(path) {
    const directIndex = __privateMethod(this, _FileTreeController_instances, getVisibleIndexByPath_fn).call(this, path);
    if (directIndex !== -1) return directIndex;
    const ancestorPaths = getAncestorDirectoryPaths(path);
    for (let index = ancestorPaths.length - 1; index >= 0; index -= 1) {
      const ancestorPath = ancestorPaths[index];
      if (ancestorPath == null) continue;
      const ancestorIndex = __privateMethod(this, _FileTreeController_instances, getVisibleIndexByPath_fn).call(this, ancestorPath);
      if (ancestorIndex !== -1) return ancestorIndex;
    }
    return __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this).length > 0 ? 0 : -1;
  }, getOrCreateItemHandle_fn = function(path, itemInfo) {
    const cachedHandle = __privateGet(this, _itemHandles).get(path);
    if (cachedHandle != null) return cachedHandle;
    const resolvedItemInfo = itemInfo ?? __privateGet(this, _store).getPathInfo(path);
    if (resolvedItemInfo == null) return null;
    const handle = resolvedItemInfo.kind === "directory" ? __privateMethod(this, _FileTreeController_instances, createDirectoryHandle_fn).call(this, resolvedItemInfo.path) : __privateMethod(this, _FileTreeController_instances, createFileHandle_fn).call(this, resolvedItemInfo.path);
    __privateGet(this, _itemHandles).set(resolvedItemInfo.path, handle);
    return handle;
  }, createVisibleRow_fn = function(row, visibleIndex, projectionIndex, projection) {
    return {
      ...
      isFocused: projection.path === __privateGet(this, _focusedPath),
      isSelected: __privateGet(this, _selectedPaths).has(projection.path),
      kind: row.kind,
      level: row.depth,
      name: row.name,
      path: projection.path,
      posInSet: projection.posInSet ?? __privateGet(this, _projectionPosInSetByIndex)[projectionIndex] ?? 0,
      setSize: projection.setSize ?? __privateGet(this, _projectionSetSizeByIndex)[projectionIndex] ?? 0
    };
  }, createVisibleRowFromContext_fn = function(context) {
    return __privateMethod(this, _FileTreeController_instances, createVisibleRow_fn).call(this, context.row, context.index, context.index, {
      ancestorPaths: context.ancestorPaths,
      path: context.row.path,
      posInSet: context.posInSet,
      setSize: context.setSize
    });
  }, getStickyCandidateContextAt_fn = function(index, slotDepth) {
    const context = __privateGet(this, _store).getVisibleRowContext(index);
  ...
  }, getAncestorIndices_fn = function(index) {
    const cached = __privateGet(this, _ancestorIndicesByIndex).get(index);
    if (cached != null) return cached;
    const parentIndex = __privateGet(this, _getParentIndexForVisibleRow).call(this, index);
    const ancestorIndices = parentIndex < 0 ? [] : [...__privateMethod(this, _FileTreeController_instances, getAncestorIndices_fn).call(this, parentIndex), parentIndex];
    __privateGet(this, _ancestorIndicesByIndex).set(index, ancestorIndices);
    return ancestorIndices;
  }, getAncestorPaths_fn = function(index) {
    const cached = __privateGet(this, _ancestorPathsByIndex).get(index);
    if (cached != null) return cached;
    const ancestorPaths = __privateMethod(this, _FileTreeController_instances, getAncestorIndices_fn).call(this, index).map((ancestorIndex) => __privateGet(this, _projectionPaths)[ancestorIndex] ?? "").filter((path) => path !== "");
    __privateGet(this, _ancestorPathsByIndex).set(index, ancestorPaths);
    return ancestorPaths;
  }, collapseDirectory_fn = function(path) {
    __privateGet(this, _store).collapse(path);
  }, applySelection_fn = function(nextSelectedPaths, nextAnchorPath = __privateGet(this, _selectionAnchorPath), emit = true) {
    const uniqueSelectedPaths = [...new Set(nextSelectedPaths)];
    const selectionChanged = !arePathSetsEqual(__privateGet(this, _selectedPaths), uniqueSelectedPaths);
    const anchorChanged = __privateGet(this, _selectionAnchorPath) !== nextAnchorPath;
    if (!selectionChanged && !anchorChanged) return;
    __privateSet(this, _selectedPaths, new Set(uniqueSelectedPaths));
    __privateSet(this, _selectionAnchorPath, nextAnchorPath);
    if (selectionChanged) __privateSet(this, _selectionVersion, __privateGet(this, _selectionVersion) + 1);
    if (emit) __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
  }, createDirectoryHandle_fn = function(path) {
    return {
      collapse: () => {
        __privateMethod(this, _FileTreeController_instances, collapseDirectory_fn).call(this, path);
      },
      deselect: () => {
        this.deselectPath(path);
      },
      expand: () => {
        __privateMethod(this, _FileTreeController_instances, expandDirectory_fn).call(this, path);
      },
      focus: () => {
        this.focusPath(path);
      },
      getPath: () => path,
      isDirectory: () => true,
      isExpanded: () => __privateGet(this, _store).isExpanded(path),
      isFocused: () => __privateGet(this, _focusedPath) === path,
      isSelected: () => __privateGet(this, _selectedPaths).has(path),
      select: () => {
      ...
      toggle: () => {
        __privateMethod(this, _FileTreeController_instances, toggleDirectory_fn).call(this, path);
      }
    };
  }, createFileHandle_fn = function(path) {
    return {
      deselect: () => {
        this.deselectPath(path);
      },
  ...
  }, validateBatchDropOperations_fn = function(operations) {
    const currentPaths = __privateGet(this, _store).list();
    __privateMethod(this, _FileTreeController_instances, createStore_fn).call(this, currentPaths).batch(operations);
  }, createStore_fn = function(paths, preparedInput, initialExpandedPathsOverride) {
    return new PathStore({
      ...__privateGet(this, _baseOptions),
      paths,
  ...
  }, getListedPaths_fn = function() {
    if (__privateGet(this, _listedPaths) != null) return __privateGet(this, _listedPaths);
    __privateSet(this, _listedPaths, __privateGet(this, _store).list());
    return __privateGet(this, _listedPaths);
  }, getAllKnownPaths_fn = function() {
    if (__privateGet(this, _knownPaths) != null) return __privateGet(this, _knownPaths);
    const knownPaths = /* @__PURE__ */ new Set();
    for (const path of __privateMethod(this, _FileTreeController_instances, getListedPaths_fn).call(this)) {
      knownPaths.add(path);
      for (const ancestorPath of getAncestorDirectoryPaths(path)) knownPaths.add(ancestorPath);
    }
    __privateSet(this, _knownPaths, [...knownPaths].sort());
    return __privateGet(this, _knownPaths);
  }, getListedPathsLowerCase_fn = function() {
    if (__privateGet(this, _listedPathsLowerCase) != null) return __privateGet(this, _listedPathsLowerCase);
    __privateSet(this, _listedPathsLowerCase, __privateMethod(this, _FileTreeController_instances, getListedPaths_fn).call(this).map(toLowerCaseSearchPath));
    return __privateGet(this, _listedPathsLowerCase);
  }, getAllKnownDirectoryPaths_fn = function() {
    if (__privateGet(this, _knownDirectoryPaths) != null) return __privateGet(this, _knownDirectoryPaths);
    __privateSet(this, _knownDirectoryPaths, __privateMethod(this, _FileTreeController_instances, getAllKnownPaths_fn).call(this).filter((path) => path.endsWith("/")));
    return __privateGet(this, _knownDirectoryPaths);
  }, getAllKnownDirectoryPathsLowerCase_fn = function() {
    if (__privateGet(this, _knownDirectoryPathsLowerCase) != null) return __privateGet(this, _knownDirectoryPathsLowerCase);
    __privateSet(this, _knownDirectoryPathsLowerCase, __privateMethod(this, _FileTreeController_instances, getAllKnownDirectoryPaths_fn).call(this).map(toLowerCaseSearchPath));
    return __privateGet(this, _knownDirectoryPathsLowerCase);
  }, invalidateKnownPathCaches_fn = function() {
    __privateSet(this, _knownDirectoryPaths, null);
    __privateSet(this, _knownDirectoryPathsLowerCase, null);
    __privateSet(this, _knownPaths, null);
    __privateSet(this, _listedPaths, null);
    __privateSet(this, _listedPathsLowerCase, null);
  }, getExpandedDirectoryPaths_fn = function() {
    return __privateMethod(this, _FileTreeController_instances, getAllKnownDirectoryPaths_fn).call(this).filter((path) => __privateGet(this, _store).isExpanded(path));
  }, restoreSearchExpandedPaths_fn = function(keepSelectedOpen) {
    const expandedPaths = new Set(__privateGet(this, _searchPreviousExpandedPaths) ?? []);
    if (keepSelectedOpen) for (const selectedPath of __privateGet(this, _selectedPaths)) for (const ancestorPath of getAncestorDirectoryPaths(selectedPath)) expandedPaths.add(ancestorPath);
    __privateMethod(this, _FileTreeController_instances, setExpandedPaths_fn).call(this, expandedPaths);
  }, setExpandedPaths_fn = function(expandedPaths) {
    __privateSet(this, _suppressStoreNotifications, true);
    try {
      for (const directoryPath of __privateMethod(this, _FileTreeController_instances, getAllKnownDirectoryPaths_fn).call(this)) {
        const shouldExpand = expandedPaths.has(directoryPath);
        const isExpanded = __privateGet(this, _store).isExpanded(directoryPath);
        if (shouldExpand && !isExpanded) __privateGet(this, _store).expand(directoryPath);
        else if (!shouldExpand && isExpanded) __privateGet(this, _store).collapse(directoryPath);
      }
    } finally {
      __privateSet(this, _suppressStoreNotifications, false);
    }
  }, syncSearchVisibilityState_fn = function() {
    if (__privateGet(this, _searchValue) == null || __privateGet(this, _searchValue).length === 0) {
      __privateSet(this, _searchMatchingPaths, []);
      __privateSet(this, _searchVisibleIndices, null);
      __privateSet(this, _searchVisiblePaths, null);
      __privateSet(this, _searchVisibleIndexByPath, null);
      __privateSet(this, _visibleCount, __privateGet(this, _storeVisibleCount));
      return;
    }
    const currentVisiblePaths = __privateGet(this, _projectionPaths);
    __privateSet(this, _searchMatchingPaths, currentVisiblePaths.filter((path) => __privateGet(this, _searchMatchPathSet).has(path)));
    if (__privateGet(this, _searchMode) !== "hide-non-matches" || __privateGet(this, _searchMatchPathSet).size === 0) {
      __privateSet(this, _searchVisibleIndices, null);
      __privateSet(this, _searchVisiblePaths, null);
      __privateSet(this, _searchVisibleIndexByPath, null);
      __privateSet(this, _visibleCount, __privateGet(this, _storeVisibleCount));
    ...
    for (const [index, path] of currentVisiblePaths.entries()) {
      if (__privateGet(this, _searchVisiblePathSet)?.has(path) !== true) continue;
      visibleIndexByPath.set(path, visiblePaths.length);
      visibleIndices.push(index);
      visiblePaths.push(path);
    }
    __privateSet(this, _searchVisibleIndices, visibleIndices);
    __privateSet(this, _searchVisiblePaths, visiblePaths);
    __privateSet(this, _searchVisibleIndexByPath, visibleIndexByPath);
    __privateSet(this, _visibleCount, visiblePaths.length);
  }, getCurrentVisiblePaths_fn = function() {
    return __privateGet(this, _searchVisiblePaths) ?? __privateGet(this, _projectionPaths);
  }, getExactCurrentVisibleIndexByPath_fn = function(path) {
    if (__privateGet(this, _searchVisiblePaths) != null) return __privateGet(this, _searchVisibleIndexByPath)?.get(path) ?? -1;
    return __privateGet(this, _store).getVisibleIndex(path) ?? -1;
  }, getProjectionIndexFromVisibleIndex_fn = function(index) {
    return __privateGet(this, _searchVisibleIndices)?.[index] ?? index;
  }, getVisibleIndexByPath_fn = function(path) {
    const searchIndex = __privateGet(this, _searchVisibleIndexByPath)?.get(path);
    if (searchIndex != null) return searchIndex;
    return __privateGet(this, _store).getVisibleIndex(path) ?? -1;
  }, focusRelativeSearchMatch_fn = function(direction) {
    const matchPaths = __privateGet(this, _searchMatchingPaths);
    if (matchPaths.length === 0) return;
    const focusedPath = __privateGet(this, _focusedPath);
  ...
  }, setSearchState_fn = function(value, emitChange) {
    var _a2;
    const normalizedValue = value == null ? null : normalizeSearchQuery(value);
    const previousSearch = __privateGet(this, _searchValue);
    if (previousSearch === normalizedValue) return;
    if (previousSearch == null && normalizedValue != null) __privateSet(this, _searchPreviousExpandedPaths, __privateMethod(this, _FileTreeController_instances, getExpandedDirectoryPaths_fn).call(this));
    __privateSet(this, _searchValue, normalizedValue);
    if (normalizedValue == null) {
      __privateMethod(this, _FileTreeController_instances, restoreSearchExpandedPaths_fn).call(this, true);
      __privateSet(this, _searchPreviousExpandedPaths, null);
      __privateGet(this, _searchMatchPathSet).clear();
      __privateSet(this, _searchVisiblePathSet, null);
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, __privateGet(this, _focusedPath), true);
    } else if (normalizedValue.length === 0) {
      __privateMethod(this, _FileTreeController_instances, restoreSearchExpandedPaths_fn).call(this, false);
      __privateGet(this, _searchMatchPathSet).clear();
      __privateSet(this, _searchVisiblePathSet, null);
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, __privateGet(this, _focusedPath), true);
    } else {
      const focusCandidate = __privateMethod(this, _FileTreeController_instances, refreshActiveSearchState_fn).call(this);
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, focusCandidate, true);
    }
    if (emitChange) {
      (_a2 = __privateGet(this, _onSearchChange)) == null ? void 0 : _a2.call(this, __privateGet(this, _searchValue));
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
    }
  }, refreshActiveSearchState_fn = function() {
    if (__privateGet(this, _searchValue) == null || __privateGet(this, _searchValue).length === 0) {
      __privateGet(this, _searchMatchPathSet).clear();
      return __privateGet(this, _focusedPath);
    }
    const searchValue = __privateGet(this, _searchValue);
    const listedPaths = __privateMethod(this, _FileTreeController_instances, getListedPaths_fn).call(this);
    const listedPathsLowerCase = __privateMethod(this, _FileTreeController_instances, getListedPathsLowerCase_fn).call(this);
    const matchingPaths = [];
    ...
    const knownDirectoryPaths = __privateMethod(this, _FileTreeController_instances, getAllKnownDirectoryPaths_fn).call(this);
    const knownDirectoryPathsLowerCase = __privateMethod(this, _FileTreeController_instances, getAllKnownDirectoryPathsLowerCase_fn).call(this);
    ...
    __privateSet(this, _searchMatchPathSet, matchingPathSet);
    const searchVisiblePathSet = __privateGet(this, _searchMode) === "hide-non-matches" && matchingPaths.length > 0 ? /* @__PURE__ */ new Set() : null;
    __privateSet(this, _searchVisiblePathSet, searchVisiblePathSet);
    const expandedPaths = __privateGet(this, _searchMode) === "expand-matches" ? new Set(__privateGet(this, _searchPreviousExpandedPaths) ?? []) : /* @__PURE__ */ new Set();
    ...
    __privateMethod(this, _FileTreeController_instances, setExpandedPaths_fn).call(this, expandedPaths);
    return focusCandidate ?? __privateGet(this, _focusedPath);
  }, emit_fn = function() {
    for (const listener of __privateGet(this, _listeners)) listener();
  }, emitMutation_fn = function(event) {
    __privateGet(this, _mutationListeners).get(event.operation)?.forEach((listener) => {
      listener(event);
    });
    __privateGet(this, _mutationListeners).get("*")?.forEach((listener) => {
      listener(event);
    });
  }, expandDirectory_fn = function(path) {
    for (const ancestorPath of getAncestorDirectoryPaths(path)) {
      if (__privateGet(this, _store).isExpanded(ancestorPath)) continue;
      __privateGet(this, _store).expand(ancestorPath);
    }
    if (!__privateGet(this, _store).isExpanded(path)) __privateGet(this, _store).expand(path);
  }, moveFocus_fn = function(offset) {
    const itemCount = __privateGet(this, _visibleCount);
    if (itemCount === 0) return;
    const currentIndex = __privateGet(this, _focusedIndex) === -1 ? 0 : __privateGet(this, _focusedIndex);
    const nextIndex = Math.min(itemCount - 1, Math.max(0, currentIndex + offset));
    if (nextIndex !== currentIndex || __privateGet(this, _focusedIndex) === -1) {
      if (!__privateGet(this, _hasFullProjection) && __privateGet(this, _searchVisibleIndices) == null && nextIndex >= __privateGet(this, _projectionPaths).length) __privateMethod(this, _FileTreeController_instances, ensureFullProjection_fn).call(this);
      __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextIndex);
    }
  }, rebuildVisibleProjection_fn = function(focusedPathCandidate, full = true) {
    const rawVisibleCount = __privateGet(this, _store).getVisibleCount();
    __privateSet(this, _storeVisibleCount, rawVisibleCount);
    const projection = createVisibleProjection(__privateGet(this, _store).getVisibleTreeProjectionData(full ? void 0 : Math.min(rawVisibleCount, INITIAL_PROJECTION_ROW_LIMIT)), focusedPathCandidate, full ? (path) => __privateGet(this, _store).getVisibleIndex(path) : void 0);
    __privateGet(this, _ancestorIndicesByIndex).clear();
    __privateGet(this, _ancestorPathsByIndex).clear();
    __privateSet(this, _hasFullProjection, projection.paths.length >= rawVisibleCount);
    __privateSet(this, _getParentIndexForVisibleRow, projection.getParentIndex);
    __privateSet(this, _projectionPaths, projection.paths);
    __privateSet(this, _projectionPosInSetByIndex, projection.posInSetByIndex);
    __privateSet(this, _projectionSetSizeByIndex, projection.setSizeByIndex);
    __privateMethod(this, _FileTreeController_instances, syncSearchVisibilityState_fn).call(this);
    __privateSet(this, _focusedIndex, focusedPathCandidate == null ? __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this).length > 0 ? 0 : -1 : __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, focusedPathCandidate));
    __privateSet(this, _focusedPath, __privateGet(this, _focusedIndex) < 0 ? null : __privateMethod(this, _FileTreeController_instances, resolveVisiblePathAtIndex_fn).call(this, __privateGet(this, _focusedIndex)));
  }, resolveVisiblePathAtIndex_fn = function(index) {
    const projectedPath = __privateMethod(this, _FileTreeController_instances, getCurrentVisiblePaths_fn).call(this)[index];
    if (projectedPath != null) return projectedPath;
    if (__privateGet(this, _searchVisibleIndices) != null) return null;
    return __privateGet(this, _store).getVisibleRowContext(index)?.row.path ?? null;
  }, resolveSelectionPath_fn = function(path) {
    return __privateGet(this, _store).getPathInfo(path)?.path ?? null;
  }, focusPathWithoutEmit_fn = function(path) {
    if (path == null) return;
    const nextFocusedIndex = __privateMethod(this, _FileTreeController_instances, resolveFocusedIndex_fn).call(this, path);
    if (nextFocusedIndex >= 0) __privateMethod(this, _FileTreeController_instances, setFocusedIndex_fn).call(this, nextFocusedIndex, false);
  }, setFocusedIndex_fn = function(index, emit = true) {
    const nextPath = __privateMethod(this, _FileTreeController_instances, resolveVisiblePathAtIndex_fn).call(this, index);
    if (nextPath == null) return;
    if (__privateGet(this, _focusedIndex) === index && __privateGet(this, _focusedPath) === nextPath) return;
    __privateSet(this, _focusedIndex, index);
    __privateSet(this, _focusedPath, nextPath);
    if (emit) __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
  }, ensureFullProjection_fn = function() {
    if (__privateGet(this, _hasFullProjection)) return;
    __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, __privateGet(this, _focusedPath), true);
  }, applyMutationState_fn = function(event) {
    const nextRenamingPath = remapPathThroughMutation(__privateGet(this, _renamingPath), event);
    if (nextRenamingPath == null && __privateGet(this, _renamingPath) != null) __privateSet(this, _renamingValue, "");
    __privateSet(this, _renamingPath, nextRenamingPath);
    const nextFocusedPath = remapPathThroughMutation(__privateGet(this, _focusedPath), event, true);
    const nextSelectedPaths = [...__privateGet(this, _selectedPaths)].map((selectedPath) => remapPathThroughMutation(selectedPath, event)).filter((resolvedPath) => resolvedPath != null).map((resolvedPath) => __privateGet(this, _store).getPathInfo(resolvedPath)?.path ?? null).filter((resolvedPath) => resolvedPath != null);
    const nextSelectionAnchorPath = remapPathThroughMutation(__privateGet(this, _selectionAnchorPath), event);
    const canonicalAnchorPath = nextSelectionAnchorPath == null ? null : __privateGet(this, _store).getPathInfo(nextSelectionAnchorPath)?.path ?? null;
    const uniqueNextSelectedPaths = [...new Set(nextSelectedPaths)];
    if (!arePathSetsEqual(__privateGet(this, _selectedPaths), uniqueNextSelectedPaths)) {
      __privateSet(this, _selectedPaths, new Set(uniqueNextSelectedPaths));
      __privateSet(this, _selectionVersion, __privateGet(this, _selectionVersion) + 1);
    }
    __privateSet(this, _selectionAnchorPath, canonicalAnchorPath);
    return nextFocusedPath;
  }, subscribe_fn = function() {
    return __privateGet(this, _store).on("*", (event) => {
      if (__privateGet(this, _suppressStoreNotifications)) return;
      if (event.canonicalChanged) {
        __privateGet(this, _itemHandles).clear();
        __privateMethod(this, _FileTreeController_instances, invalidateKnownPathCaches_fn).call(this);
      }
      if (__privateGet(this, _dragSession) != null && isPathMutationEvent(event)) __privateSet(this, _dragSession, null);
      const focusPathCandidate = isPathMutationEvent(event) ? __privateMethod(this, _FileTreeController_instances, applyMutationState_fn).call(this, event) : __privateGet(this, _focusedPath);
      const searchFocusCandidate = __privateGet(this, _searchValue) != null && __privateGet(this, _searchValue).length > 0 ? __privateMethod(this, _FileTreeController_instances, refreshActiveSearchState_fn).call(this) : __privateGet(this, _searchValue) === "" ? __privateGet(this, _focusedPath) : focusPathCandidate;
      const shouldBuildFullProjection = __privateGet(this, _searchValue) != null || event.operation !== "expand" && event.operation !== "collapse";
      __privateMethod(this, _FileTreeController_instances, rebuildVisibleProjection_fn).call(this, searchFocusCandidate, shouldBuildFullProjection);
      __privateMethod(this, _FileTreeController_instances, emit_fn).call(this);
      const mutationEvent = toTreesMutationEvent(event);
      if (mutationEvent != null) __privateMethod(this, _FileTreeController_instances, emitMutation_fn).call(this, mutationEvent);
    });
  }, toggleDirectory_fn = function(path) {
    if (__privateGet(this, _store).isExpanded(path)) {
      __privateMethod(this, _FileTreeController_instances, collapseDirectory_fn).call(this, path);
      return;
    }
    __privateMethod(this, _FileTreeController_instances, expandDirectory_fn).call(this, path);
  }, Object.defineProperty(_a.prototype, FILE_TREE_RENAME_VIEW, {
    configurable: true,
    value() {
      return {
        cancel: () => {
          __privateMethod(this, _FileTreeController_instances, cancelRenaming_fn).call(this);
        },
        commit: () => {
          __privateMethod(this, _FileTreeController_instances, completeRenaming_fn).call(this);
        },
        getPath: () => __privateGet(this, _renamingPath),
        getValue: () => __privateGet(this, _renamingValue),
        isActive: () => __privateGet(this, _renamingPath) != null,
        setValue: (value) => {
          __privateMethod(this, _FileTreeController_instances, setRenamingValue_fn).call(this, value);
        }
      };
    },
    writable: true
  ...
  // node_modules/@pierre/trees/dist/utils/getGitStatusSignature.js
  var getGitStatusSignature = (entries) => {
  ...
  // node_modules/@pierre/trees/dist/utils/normalizeInputPath.js
  function normalizeInputPath(inputPath) {
    const isDirectory = inputPath.endsWith("/");
    let normalizedPath = "";
    let segmentStart = -1;
    for (let i3 = 0; i3 <= inputPath.length; i3 += 1) {
      if (!(inputPath[i3] === "/" || i3 === inputPath.length)) {
        if (segmentStart === -1) segmentStart = i3;
        continue;
      }
      if (segmentStart === -1) continue;
      if (normalizedPath !== "") normalizedPath += "/";
      normalizedPath += inputPath.slice(segmentStart, i3);
      segmentStart = -1;
    }
  ...
  // node_modules/@pierre/trees/dist/model/gitStatus.js
  function getAncestorDirectoryPaths2(path) {
    const normalizedPath = path.endsWith("/") ? path.slice(0, -1) : path;
    if (normalizedPath.length === 0) return [];
    const ancestors = [];
    let searchIndex = 0;
  ...
  function resolveFileTreeGitStatusState(entries, previous = null) {
    ...
    const changeCountByDirectoryPath = /* @__PURE__ */ new Map();
  ...
  function applyFileTreeGitStatusPatch(previous, patch) {
    const removeEntries = patch?.remove ?? [];
    const setEntries = patch?.set ?? [];
    if (removeEntries.length === 0 && setEntries.length === 0) return previous;
  ...
  function resolveGitStatusEntry(entry) {
    return resolveGitStatusPath(entry.path);
  }
  function resolveGitStatusPath(path) {
  ...
  function removeGitStatusPath({ canonicalPath, changeCountByDirectoryPath, directoriesWithChanges, ignoredDirectoryPaths, statusByPath }) {
    const previousStatus = statusByPath.get(canonicalPath);
    if (previousStatus == null) return false;
    statusByPath.delete(canonicalPath);
    if (previousStatus === "ignored" && canonicalPath.endsWith("/")) ignoredDirectoryPaths.delete(canonicalPath);
    decrementAncestorChangeCounts(changeCountByDirectoryPath, directoriesWithChanges, canonicalPath);
    return true;
  }
  function setGitStatusPath({ canonicalPath, changeCountByDirectoryPath, directoriesWithChanges, ignoredDirectoryPaths, isDirectory, status: status2, statusByPath }) {
    const previousStatus = statusByPath.get(canonicalPath);
    if (previousStatus === status2) return false;
    if (previousStatus == null) incrementAncestorChangeCounts(changeCountByDirectoryPath, directoriesWithChanges, canonicalPath);
    statusByPath.set(canonicalPath, status2);
    if (status2 === "ignored" && isDirectory) ignoredDirectoryPaths.add(canonicalPath);
    else if (isDirectory) ignoredDirectoryPaths.delete(canonicalPath);
    return true;
  }
  function incrementAncestorChangeCounts(changeCountByDirectoryPath, directoriesWithChanges, path) {
    for (const ancestorPath of getAncestorDirectoryPaths2(path)) {
      changeCountByDirectoryPath.set(ancestorPath, (changeCountByDirectoryPath.get(ancestorPath) ?? 0) + 1);
      directoriesWithChanges.add(ancestorPath);
    }
  }
  function decrementAncestorChangeCounts(changeCountByDirectoryPath, directoriesWithChanges, path) {
    for (const ancestorPath of getAncestorDirectoryPaths2(path)) {
      const nextCount = (changeCountByDirectoryPath.get(ancestorPath) ?? 0) - 1;
      if (nextCount > 0) changeCountByDirectoryPath.set(ancestorPath, nextCount);
      else {
  ...
  function getGitStatusStateSignature(statusByPath) {
    let signature = `${statusByPath.size}`;
    for (const [path, status2] of statusByPath) signature += `\0${path}\0${status2}`;
    return signature;
  }
  ...
  function _(n2, l3, u4) {
    var t3, i3, r3, f3 = {};
    for (r3 in l3) "key" == r3 ? t3 = l3[r3] : "ref" == r3 && "function" != typeof n2 ? i3 = l3[r3] : f3[r3] = l3[r3];
    return arguments.length > 2 && (f3.children = arguments.length > 3 ? y.call(arguments, 2) : u4), g(n2, f3, t3, i3, null);
  }
  function g(u4, t3, i3, r3, f3) {
    var e3 = { type: u4, props: t3, key: i3, ref: r3, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == f3 ? ++l : f3, __i: -1, __u: 0 };
    return null == f3 && null != n.vnode && n.vnode(e3), e3;
  }
  function k(n2) {
    return n2.children;
  }
  function m(n2, l3) {
    this.props = n2, this.context = l3, this.__g = 0;
  }
  function M(n2, l3) {
    if (null == l3) return n2.__ ? M(n2.__, n2.__i + 1) : null;
  ...
  function S(n2) {
    ...
    if (null != (n2 = n2.__) && null != n2.__c) {
      for (n2.__e = null, l3 = 0; l3 < n2.__k.length; l3++) if (null != (u4 = n2.__k[l3]) && null != u4.__e) {
        n2.__e = u4.__e;
        break;
      }
      return S(n2);
  ...
  function $(l3) {
    (8 & l3.__g || !(l3.__g |= 8) || !t.push(l3) || r++) && i == n.debounceRendering || ((i = n.debounceRendering) || queueMicrotask)(x);
  }
  function x() {
    for (var l3, u4, i3, e3, o4, c3, s3, a3, h3 = 1; t.length; ) t.length > h3 && t.sort(f), l3 = t.shift(), h3 = t.length, 8 & l3.__g && (i3 = void 0, o4 = (e3 = (u4 = l3).__v).__e, c3 = [], s3 = [], (a3 = u4.__P) && ((i3 = w({}, e3)).__v = e3.__v + 1, n.vnode && n.vnode(i3), q(a3, i3, e3, u4.__n, a3.namespaceURI, 32 & e3.__u ? [o4] : null, c3, null == o4 ? M(e3) : o4, !!(32 & e3.__u), s3, a3.ownerDocument), i3.__v = e3.__v, i3.__.__k[i3.__i] = i3, P(c3, i3, s3), i3.__e != o4 && S(i3)));
    r = 0;
  }
  function C(n2, l3, u4, t3, i3, r3, f3, e3, o4, c3, s3, a3) {
    var v3, y3, w3, d3, _3, g3, b2, k3 = t3 && t3.__k || p, m3 = l3.length;
    for (o4 = j(u4, l3, k3, o4, m3), v3 = 0; v3 < m3; v3++) null != (w3 = u4.__k[v3]) && (y3 = -1 == w3.__i ? h : k3[w3.__i] || h, w3.__i = v3, g3 = q(n2, w3, y3, i3, r3, f3, e3, o4, c3, s3, a3), d3 = w3.__e, w3.ref && y3.ref != w3.ref && (y3.ref && B(y3.ref, null, w3), s3.push(w3.ref, w3.__c || d3, w3)), null == _3 && null != d3 && (_3 = d3), (b2 = !!(4 & w3.__u)) || y3.__k === w3.__k ? o4 = A(w3, o4, n2, b2) : "function" == typeof w3.type && void 0 !== g3 ? o4 = g3 : d3 && (o4 = d3.nextSibling), w3.__u &= -7);
    return u4.__e = _3, o4;
  }
  function j(n2, l3, u4, t3, i3) {
    var r3, f3, e3, o4, c3, s3 = u4.length, a3 = s3, h3 = 0;
    for (n2.__k = new Array(i3), r3 = 0; r3 < i3; r3++) null != (f3 = l3[r3]) && "boolean" != typeof f3 && "function" != typeof f3 ? (o4 = r3 + h3, (f3 = n2.__k[r3] = "string" == typeof f3 || "number" == typeof f3 || "bigint" == typeof f3 || f3.constructor == String ? g(null, f3, null, null, null) : v(f3) ? g(k, { children: f3 }, null, null, null) : null == f3.constructor && f3.__b > 0 ? g(f3.type, f3.props, f3.key, f3.ref ? f3.ref : null, f3.__v) : f3).__ = n2, f3.__b = n2.__b + 1, e3 = null, -1 != (c3 = f3.__i = I(f3, u4, o4, a3)) && (a3--, (e3 = u4[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof f3.type && (f3.__u |= 4)) : c3 != o4 && (c3 == o4 - 1 ? h3-- : c3 == o4 + 1 ? h3++ : (c3 > o4 ? h3-- : h3++, f3.__u |= 4))) : n2.__k[r3] = null;
    if (a3) for (r3 = 0; r3 < s3; r3++) null != (e3 = u4[r3]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = M(e3)), D(e3, e3));
    return t3;
  }
  function A(n2, l3, u4, t3) {
    ...
    n2.__e != l3 && (t3 && (l3 && n2.type && !l3.parentNode && (l3 = M(n2)), u4.insertBefore(n2.__e, l3 || null)), l3 = n2.__e);
    do {
  ...
  function I(n2, l3, u4, t3) {
    var i3, r3, f3, e3 = n2.key, o4 = n2.type, c3 = l3[u4], s3 = null != c3 && 0 == (2 & c3.__u);
    if (null === c3 && null == n2.key || s3 && e3 == c3.key && o4 == c3.type) return u4;
    if (t3 > (s3 ? 1 : 0)) {
      for (i3 = u4 - 1, r3 = u4 + 1; i3 >= 0 || r3 < l3.length; ) if (null != (c3 = l3[f3 = i3 >= 0 ? i3-- : r3++]) && 0 == (2 & c3.__u) && e3 == c3.key && o4 == c3.type) return f3;
    }
    return -1;
  }
  function L(n2, l3, u4) {
    "-" == l3[0] ? n2.setProperty(l3, null == u4 ? "" : u4) : n2[l3] = null == u4 ? "" : u4;
  }
  function O(n2, l3, u4, t3, i3) {
    var r3;
    n: if ("style" == l3) if ("string" == typeof u4) n2.style.cssText = u4;
    else {
      if ("string" == typeof t3 && (n2.style.cssText = t3 = ""), t3) for (l3 in t3) u4 && l3 in u4 || L(n2.style, l3, "");
      if (u4) for (l3 in u4) t3 && u4[l3] == t3[l3] || L(n2.style, l3, u4[l3]);
    }
    else if ("o" == l3[0] && "n" == l3[1]) r3 = l3 != (l3 = l3.replace(e, "$1")), (l3 = l3.slice(2))[0].toLowerCase() != l3[0] && (l3 = l3.toLowerCase()), n2.__l || (n2.__l = {}), n2.__l[l3 + r3] = u4, u4 ? t3 ? u4.l = t3.l : (u4.l = o, n2.addEventListener(l3, r3 ? s : c, r3)) : n2.removeEventListener(l3, r3 ? s : c, r3);
    else {
  ...
  function T(l3) {
    return function(u4) {
      if (this.__l) {
        var t3 = this.__l[u4.type + l3];
        if (null == u4.u) u4.u = o++;
        else if (u4.u < t3.l) return;
        return t3(n.event ? n.event(u4) : u4);
      }
    };
  }
  function q(l3, u4, t3, i3, r3, f3, e3, o4, c3, s3, a3) {
    var h3, p3, y3, _3, g3, b2, M2, S2, $2, x2, j2, A3, H, I2, L2, O2, T2, q3, P2, B4, D3, F3 = u4.type;
    if (null != u4.constructor) return null;
    128 & t3.__u && (c3 = !!(32 & t3.__u), t3.__c.__z && (o4 = u4.__e = t3.__e = (f3 = t3.__c.__z)[0], t3.__c.__z = null)), (h3 = n.__b) && h3(u4);
    n: if ("function" == typeof F3) try {
      if (S2 = u4.props, $2 = "prototype" in F3 && F3.prototype.render, x2 = (h3 = F3.contextType) && i3[h3.__c], j2 = h3 ? x2 ? x2.props.value : h3.__ : i3, t3.__c ? 2 & (p3 = u4.__c = t3.__c).__g && (p3.__g |= 1, M2 = true) : ($2 ? u4.__c = p3 = new F3(S2, j2) : (u4.__c = p3 = new m(S2, j2), p3.constructor = F3, p3.render = E), x2 && x2.sub(p3), p3.props = S2, p3.state || (p3.state = {}), p3.context = j2, p3.__n = i3, y3 = true, p3.__g |= 8, p3.__h = [], p3._sb = []), $2 && null == p3.__s && (p3.__s = p3.state), $2 && null != F3.getDerivedStateFromProps && (p3.__s == p3.state && (p3.__s = w({}, p3.__s)), w(p3.__s, F3.getDerivedStateFromProps(S2, p3.__s))), _3 = p3.props, g3 = p3.state, p3.__v = u4, y3) $2 && null == F3.getDerivedStateFromProps && null != p3.componentWillMount && p3.componentWillMount(), $2 && null != p3.componentDidMount && p3.__h.push(p3.componentDidMount);
      else {
        if ($2 && null == F3.getDerivedStateFromProps && S2 !== _3 && null != p3.componentWillReceiveProps && p3.componentWillReceiveProps(S2, j2), !(4 & p3.__g) && null != p3.shouldComponentUpdate && false === p3.shouldComponentUpdate(S2, p3.__s, j2) || u4.__v == t3.__v) {
          for (u4.__v != t3.__v && (p3.props = S2, p3.state = p3.__s, p3.__g &= -9), u4.__e = t3.__e, u4.__k = t3.__k, u4.__k.some(function(n2) {
            n2 && (n2.__ = u4);
          }), A3 = 0; A3 < p3._sb.length; A3++) p3.__h.push(p3._sb[A3]);
          p3._sb = [], p3.__h.length && e3.push(p3);
          break n;
        }
        null != p3.componentWillUpdate && p3.componentWillUpdate(S2, p3.__s, j2), $2 && null != p3.componentDidUpdate && p3.__h.push(function() {
          p3.componentDidUpdate(_3, g3, b2);
        });
      }
      if (p3.context = j2, p3.props = S2, p3.__P = l3, p3.__g &= -5, H = n.__r, I2 = 0, $2) {
        for (p3.state = p3.__s, p3.__g &= -9, H && H(u4), h3 = p3.render(p3.props, p3.state, p3.context), L2 = 0; L2 < p3._sb.length; L2++) p3.__h.push(p3._sb[L2]);
        p3._sb = [];
      } else do {
        p3.__g &= -9, H && H(u4), h3 = p3.render(p3.props, p3.state, p3.context), p3.state = p3.__s;
      } while (8 & p3.__g && ++I2 < 25);
      p3.state = p3.__s, null != p3.getChildContext && (i3 = w({}, i3, p3.getChildContext())), $2 && !y3 && null != p3.getSnapshotBeforeUpdate && (b2 = p3.getSnapshotBeforeUpdate(_3, g3)), O2 = h3, null != h3 && h3.type === k && null == h3.key && (O2 = V(h3.props.children)), o4 = C(l3, v(O2) ? O2 : [O2], u4, t3, i3, r3, f3, e3, o4, c3, s3, a3), u4.__u &= -161, p3.__h.length && e3.push(p3), M2 && (p3.__g &= -4);
    } catch (l4) {
      if (u4.__v = null, c3 || null != f3) if (l4.then) {
        for (T2 = 0, q3 = false, u4.__u |= c3 ? 160 : 128, u4.__c.__z = [], P2 = 0; P2 < f3.length; P2++) null == (B4 = f3[P2]) || q3 || (8 == B4.nodeType && "$s" == B4.data ? (T2 > 0 && u4.__c.__z.push(B4), T2++, f3[P2] = null) : 8 == B4.nodeType && "/$s" == B4.data ? (--T2 > 0 && u4.__c.__z.push(B4), q3 = 0 === T2, o4 = f3[P2], f3[P2] = null) : T2 > 0 && (u4.__c.__z.push(B4), f3[P2] = null));
        if (!q3) {
          for (; o4 && 8 == o4.nodeType && o4.nextSibling; ) o4 = o4.nextSibling;
          f3[f3.indexOf(o4)] = null, u4.__c.__z = [o4];
        }
        u4.__e = o4;
      } else {
        for (D3 = f3.length; D3--; ) d(f3[D3]);
        N(u4);
      }
      else u4.__e = t3.__e, u4.__k = t3.__k, l4.then || N(u4);
      n.__e(l4, u4, t3);
    }
    else o4 = u4.__e = z(t3.__e, u4, t3, i3, r3, f3, e3, c3, s3, a3);
    return (h3 = n.diffed) && h3(u4), 128 & u4.__u ? void 0 : o4;
  }
  function N(n2) {
  ...
  function P(l3, u4, t3) {
    ...
    n.__c && n.__c(u4, l3), l3.some(function(u5) {
      try {
        l3 = u5.__h, u5.__h = [], l3.some(function(n2) {
          n2.call(u5);
        });
      } catch (l4) {
        n.__e(l4, u5.__v);
  ...
  function V(n2) {
    return "object" != typeof n2 || null == n2 || n2.__b && n2.__b > 0 ? n2 : v(n2) ? n2.map(V) : w({}, n2);
  }
  function z(l3, u4, t3, i3, r3, f3, e3, o4, c3, s3) {
    var a3, p3, w3, _3, g3, b2, k3, m3, S2 = t3.props, $2 = u4.props, x2 = u4.type;
    if ("svg" == x2 ? r3 = "http://www.w3.org/2000/svg" : "math" == x2 ? r3 = "http://www.w3.org/1998/Math/MathML" : r3 || (r3 = "http://www.w3.org/1999/xhtml"), null != f3) {
      for (a3 = 0; a3 < f3.length; a3++) if ((g3 = f3[a3]) && "setAttribute" in g3 == !!x2 && (x2 ? g3.localName == x2 : 3 == g3.nodeType)) {
        l3 = g3, f3[a3] = null;
        break;
      }
    }
    if (null == l3) {
      if (null == x2) return s3.createTextNode($2);
      l3 = s3.createElementNS(r3, x2, $2.is && $2), o4 && (n.__m && n.__m(u4, f3), o4 = false), f3 = null;
    }
    if (null == x2) S2 === $2 || o4 && l3.data == $2 || (l3.data = $2);
    else {
      if (f3 = f3 && y.call(l3.childNodes), S2 = t3.props || h, !o4 && null != f3) for (S2 = {}, a3 = 0; a3 < l3.attributes.length; a3++) S2[(g3 = l3.attributes[a3]).name] = g3.value;
      for (a3 in S2) if (g3 = S2[a3], "children" == a3) ;
      else if ("dangerouslySetInnerHTML" == a3) w3 = g3;
      else if (!(a3 in $2)) {
        if ("value" == a3 && "defaultValue" in $2 || "checked" == a3 && "defaultChecked" in $2) continue;
        O(l3, a3, null, g3, r3);
      }
      for (a3 in m3 = 1 & t3.__u, $2) g3 = $2[a3], "children" == a3 ? _3 = g3 : "dangerouslySetInnerHTML" == a3 ? p3 = g3 : "value" == a3 ? b2 = g3 : "checked" == a3 ? k3 = g3 : o4 && "function" != typeof g3 || S2[a3] === g3 && !m3 || O(l3, a3, g3, S2[a3], r3);
      if (p3) o4 || w3 && (p3.__html == w3.__html || p3.__html == l3.innerHTML) || (l3.innerHTML = p3.__html), u4.__k = [];
      else if (w3 && (l3.innerHTML = ""), C("template" == x2 ? l3.content : l3, v(_3) ? _3 : [_3], u4, t3, i3, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : r3, f3, e3, f3 ? f3[0] : t3.__k && M(t3, 0), o4, c3, s3), null != f3) for (a3 = f3.length; a3--; ) d(f3[a3]);
      o4 || (a3 = "value", "progress" == x2 && null == b2 ? l3.removeAttribute("value") : null == b2 || b2 === l3[a3] && ("progress" !== x2 || b2) || O(l3, a3, b2, S2[a3], r3), a3 = "checked", null != k3 && k3 != l3[a3] && O(l3, a3, k3, S2[a3], r3));
    }
    return l3;
  }
  function B(l3, u4, t3) {
    try {
      if ("function" == typeof l3) {
        var i3 = "function" == typeof l3.__u;
        i3 && l3.__u(), i3 && null == u4 || (l3.__u = l3(u4));
      } else l3.current = u4;
    } catch (l4) {
      n.__e(l4, t3);
    }
  ...
  function D(l3, u4, t3) {
    var i3, r3;
    if (n.unmount && n.unmount(l3), (i3 = l3.ref) && (i3.current && i3.current != l3.__e || B(i3, null, u4)), null != (i3 = l3.__c)) {
    ...
    if (i3 = l3.__k) for (r3 = 0; r3 < i3.length; r3++) i3[r3] && D(i3[r3], u4, t3 || "function" != typeof l3.type);
    t3 || d(l3.__e), l3.__e && l3.__e.__l && (l3.__e.__l = null), l3.__e = l3.__c = l3.__ = null;
  }
  function E(n2, l3, u4) {
  ...
  function F(l3, u4) {
    var t3, i3, r3, f3;
    u4 == document && (u4 = document.documentElement), n.__ && n.__(l3, u4), i3 = (t3 = !!(l3 && 32 & l3.__u)) ? null : u4.__k, l3 = u4.__k = _(k, null, [l3]), r3 = [], f3 = [], q(u4, l3, i3 || h, h, u4.namespaceURI, i3 ? null : u4.firstChild ? y.call(u4.childNodes) : null, r3, i3 ? i3.__e : u4.firstChild, t3, f3, u4.ownerDocument), P(r3, l3, f3);
  }
  function G(n2, l3) {
    n2.__u |= 32, F(n2, l3);
  }
  n = { __e: function(n2, l3, u4, t3) {
    for (var i3, f3, e3; l3 = l3.__; ) if ((i3 = l3.__c) && !(1 & i3.__g)) {
      i3.__g |= 4;
      try {
        if ((f3 = i3.constructor) && null != f3.getDerivedStateFromError && (i3.setState(f3.getDerivedStateFromError(n2)), e3 = 8 & i3.__g), null != i3.componentDidCatch && (i3.componentDidCatch(n2, t3 || {}), e3 = 8 & i3.__g), e3) return void (i3.__g |= 2);
      } catch (l4) {
        n2 = l4;
      }
    }
  ...
  }, m.prototype.render = k, t = [], r = 0, f = function(n2, l3) {
    return n2.__v.__b - l3.__v.__b;
  }, e = /(PointerCapture)$|Capture$/i, o = 0, c = T(false), s = T(true), a = 0;
  ...
  function u2(t3, e3, n2, f3, u4, i3) {
    ...
    var p3 = { type: t3, props: l3, key: n2, ref: a3, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --o2, __i: -1, __u: 0, __source: u4, __self: i3 };
    return n.vnode && n.vnode(p3), p3;
  }

  // node_modules/@pierre/trees/dist/components/Icon.js
  var DEFAULT_WIDTH = 16;
  var DEFAULT_HEIGHT = 16;
  var ICON_SIZE_OVERRIDES = {};
  function Icon({ name, remappedFrom, token, width: propWidth, height: propHeight, viewBox: propViewBox, label, alignCapitals = false }) {
    ...
    return /* @__PURE__ */ u2("svg", {
      ...
      width,
      height,
      children: /* @__PURE__ */ u2("use", { href })
    });
  }

  // node_modules/@pierre/trees/dist/components/OverflowText.js
  var isWhitespace = (char) => char !== void 0 && /\s/.test(char);
  var avoidWhitespaceBoundary = (contents, centerIndex) => {
    const isOnBoundary = (index) => isWhitespace(contents[index - 1]) || isWhitespace(contents[index]);
  ...
  var centerSplitIndex = (contents) => avoidWhitespaceBoundary(contents, Math.ceil(contents.length / 2));
  var splitCenter = (contents) => {
  ...
  var splitExtension = (contents) => {
    ...
    const splitIndex = extensionIndex >= 1 && !isTooLong ? extensionIndex : centerSplitIndex(contents);
    return [contents.slice(0, splitIndex), contents.slice(splitIndex)];
  };
  var splitLeafPath = (contents) => {
    if (contents.length < 4) return [contents, ""];
  ...
  var splitByIndex = (contents, { splitIndex } = {}) => {
  ...
  var splitLast = (contents, { splitOffset } = {}) => {
  ...
  var splitFirst = (contents, { splitOffset } = {}) => {
    if (typeof splitOffset !== "number" || splitOffset <= 0 || splitOffset >= contents.length) {
      const centerIndex = Math.ceil(contents.length / 2);
      return [contents.slice(0, centerIndex), contents.slice(centerIndex)];
    }
  ...
  function OverflowMarker({ children, marker, variant = "default" }) {
    ...
    return /* @__PURE__ */ u2("div", {
      ...
      children: /* @__PURE__ */ u2("div", {
        ...
        children: typeof marker === "function" ? marker({ children }) : variant === "fade" ? /* @__PURE__ */ u2("span", { "data-truncate-fade": true }) : marker
      })
    });
  }
  function OverflowContent(options) {
    ...
    return /* @__PURE__ */ u2("div", { children: [/* @__PURE__ */ u2("div", {
      "data-truncate-content": "visible",
      children: mode === "fruncate" ? /* @__PURE__ */ u2("span", { children }) : children
    }), /* @__PURE__ */ u2("div", {
      "data-truncate-content": "overflow",
      "aria-hidden": true,
      children: mode === "fruncate" ? /* @__PURE__ */ u2("span", { children }) : children
  ...
  function OverflowText({ children, mode = "truncate", marker = "\u2026", variant = "default", ...props }) {
    "use no memo";
    const contentNode = /* @__PURE__ */ u2(OverflowContent, {
      mode,
      children
    }, "content");
    const markerNode = /* @__PURE__ */ u2(OverflowMarker, {
      marker,
      mode,
      variant
    }, "marker");
    const fillNode = /* @__PURE__ */ u2("div", { "data-truncate-fill": true }, "fill");
    return /* @__PURE__ */ u2("div", {
  ...
  function Truncate({ children, ...props }) {
    "use no memo";
    return /* @__PURE__ */ u2(OverflowText, {
      mode: "truncate",
      ...props,
      children
    });
  ...
  function MiddleTruncate({ children, contents, priority = "end", split = "center", minimumLength = 12, className, style, ...props }) {
    ...
    if (Array.isArray(contents)) {
      ...
      firstSegment = /* @__PURE__ */ u2(Truncate, {
        ...props,
        children: contents[0]
      });
      secondSegment = /* @__PURE__ */ u2(Fruncate, {
        ...props,
        children: contents[1]
      });
    } else {
      ...
      if (children.length === 0) return /* @__PURE__ */ u2("div", {
        className,
        style
      });
      if (children.length < minimumLength) if (priority === "end") return /* @__PURE__ */ u2(Fruncate, {
        ...props,
        className,
        style,
        children
      });
      else return /* @__PURE__ */ u2(Truncate, {
        ...props,
        className,
        style,
        children
  ...
  // node_modules/@pierre/trees/dist/model/layout.js
  var EMPTY_FILE_TREE_LAYOUT_RANGE = {
    endIndex: -1,
    startIndex: -1
  };
  ...
  // node_modules/@pierre/trees/dist/utils/gitStatusPresentation.js
  var GIT_STATUS_LABEL = {
    added: "A",
    deleted: "D",
    ignored: null,
    modified: "M",
  ...
  var GIT_STATUS_DESCENDANT_TITLE = "Contains git status items";

  // node_modules/@pierre/trees/dist/render/controllerSnapshotSubscription.js
  function shouldBumpControllerRevision(hasSeenInitialSnapshot) {
    if (hasSeenInitialSnapshot.current) return true;
    hasSeenInitialSnapshot.current = true;
    return false;
  }

  // node_modules/@pierre/trees/dist/render/scrollTarget.js
  ...
  // node_modules/@pierre/trees/dist/render/focusHelpers.js
  ...
  function getActiveTreeElement(rootElement) {
    ...
    if (rootNode instanceof ShadowRoot) {
      const activeElement2 = rootNode.activeElement;
      return activeElement2 instanceof HTMLElement ? activeElement2 : null;
    }
  ...
  // node_modules/@pierre/trees/dist/render/renameHandoff.js
  ...
  // node_modules/@pierre/trees/dist/render/RenameInput.js
  function RenameInput({ ariaLabel, isFlattened = false, ref, value, onBlur, onInput }) {
    return /* @__PURE__ */ u2("input", {
      ref,
  ...
  // node_modules/@pierre/trees/dist/render/rowAttributes.js
  ...
  // node_modules/@pierre/trees/dist/render/rowClickPlan.js
  ...
  var p2 = e2.__;
  function d2(n2, t3) {
    e2.__h && e2.__h(r2, n2, f2 || t3), f2 = 0;
    var u4 = r2.__H || (r2.__H = { __: [], __h: [] });
    return n2 >= u4.__.length && u4.__.push({}), u4.__[n2];
  }
  function h2(n2) {
    return f2 = 1, y2(D2, n2);
  }
  function y2(n2, u4, i3) {
    var f3 = d2(t2++, 2);
    if (f3.t = n2, !f3.__c && (f3.__ = [i3 ? i3(u4) : D2(void 0, u4), function(n3) {
      var t3 = f3.__N ? f3.__N[0] : f3.__[0], r3 = f3.t(t3, n3);
      o3(t3, r3) || (f3.__N = [r3, f3.__[1]], f3.__c.setState({}));
    }], f3.__c = r2, !r2.__f)) {
      var c3 = function(n3, t3, r3) {
        if (!f3.__c.__H) return true;
        var u5 = f3.__c.__H.__.filter(function(n4) {
          return !!n4.__c;
        });
        if (u5.every(function(n4) {
          return !n4.__N;
        })) return !e3 || e3.call(this, n3, t3, r3);
        var i4 = f3.__c.props !== n3;
        return u5.forEach(function(n4) {
          if (n4.__N) {
            var t4 = n4.__[0];
            n4.__ = n4.__N, n4.__N = void 0, o3(t4, n4.__[0]) || (i4 = true);
          }
        }), e3 && e3.call(this, n3, t3, r3) || i4;
      };
      r2.__f = true;
      var e3 = r2.shouldComponentUpdate, a3 = r2.componentWillUpdate;
      r2.componentWillUpdate = function(n3, t3, r3) {
        if (4 & this.__g) {
          var u5 = e3;
          e3 = void 0, c3(n3, t3, r3), e3 = u5;
        }
        a3 && a3.call(this, n3, t3, r3);
      }, r2.shouldComponentUpdate = c3;
    }
    return f3.__N || f3.__;
  }
  function _2(n2, u4) {
    var i3 = d2(t2++, 3);
    !e2.__s && C2(i3.__H, u4) && (i3.__ = n2, i3.u = u4, r2.__H.__h.push(i3));
  }
  function A2(n2, u4) {
    var i3 = d2(t2++, 4);
    !e2.__s && C2(i3.__H, u4) && (i3.__ = n2, i3.u = u4, r2.__h.push(i3));
  }
  function F2(n2) {
    return f2 = 5, q2(function() {
      return { current: n2 };
    }, []);
  }
  function q2(n2, r3) {
  ...
  function b(n2, t3) {
    return f2 = 8, q2(function() {
      return n2;
    }, t3);
  }
  function g2() {
    for (var n2; n2 = c2.shift(); ) if (n2.__P && n2.__H) try {
  ...
  e2.__b = function(n2) {
    ...
    l2 && l2(n2);
    var t3 = n2.__c;
    t3 && t3.__H && (t3.__H.__h.length && (1 !== c2.push(t3) && i2 === e2.requestAnimationFrame || ((i2 = e2.requestAnimationFrame) || w2)(g2)), t3.__H.__.forEach(function(n3) {
  ...
  // node_modules/@pierre/trees/dist/render/FileTreeView.js
  function formatFlattenedSegments(row, renameInput = null, dragTargetFlattenedSegmentPath = null) {
    ...
    return /* @__PURE__ */ u2("span", {
      ...
      children: segments.map((segment, index) => {
        ...
        return /* @__PURE__ */ u2(k, { children: [/* @__PURE__ */ u2("span", {
          ...
          children: isLast && renameInput != null ? renameInput : /* @__PURE__ */ u2(Truncate, { children: segment.name })
  ...
  var TOUCH_LONG_PRESS_DELAY = 400;
  var TOUCH_LONG_PRESS_MOVE_THRESHOLD = 10;
  var DRAG_EDGE_SCROLL_THRESHOLD = 40;
  var DRAG_EDGE_SCROLL_MAX_SPEED = 18;
  ...
  function getDragEdgeScrollDelta(clientY, scrollRect) {
    ...
    if (topDistance < DRAG_EDGE_SCROLL_THRESHOLD) return -Math.ceil((DRAG_EDGE_SCROLL_THRESHOLD - Math.max(0, topDistance)) / DRAG_EDGE_SCROLL_THRESHOLD * DRAG_EDGE_SCROLL_MAX_SPEED);
    const bottomDistance = scrollRect.bottom - clientY;
    if (bottomDistance < DRAG_EDGE_SCROLL_THRESHOLD) return Math.ceil((DRAG_EDGE_SCROLL_THRESHOLD - Math.max(0, bottomDistance)) / DRAG_EDGE_SCROLL_THRESHOLD * DRAG_EDGE_SCROLL_MAX_SPEED);
    return 0;
  }
  ...
  var BLOCKED_CONTEXT_MENU_NAV_KEYS = /* @__PURE__ */ new Set([
    "ArrowDown",
    "ArrowLeft",
    "ArrowRight",
    "ArrowUp",
  ...
  function isEventInContextMenu(event) {
    for (const entry of event.composedPath()) {
      ...
      if (entry.dataset.type === "context-menu-anchor" || entry.dataset.type === "context-menu-trigger") return true;
      if (entry.getAttribute("slot") === "context-menu") return true;
    }
    return false;
  }
  ...
  function createAnchorRectFromPoint(x2, y3) {
    return {
      bottom: y3,
      height: 0,
      left: x2,
  ...
  function renderRowDecoration(decoration, resolveIcon) {
    ...
    if ("text" in decoration) {
      if (decoration.parts != null) return /* @__PURE__ */ u2("span", {
        title: decoration.title,
        children: decoration.parts.map((part, index) => /* @__PURE__ */ u2("span", {
    ...
    return /* @__PURE__ */ u2("span", {
      title: decoration.title,
      children: /* @__PURE__ */ u2(Icon, { ...icon })
    });
  }
  ...
  function renderFileTreeRowContent(row, resolveIcon, { actionLaneEnabled = false, customDecoration = null, decorationLaneEnabled = false, dragTargetFlattenedSegmentPath = null, gitDecoration = null, gitLaneActive = false, renameInput = null, showDecorativeActionAffordance = false } = {}) {
    ...
    return /* @__PURE__ */ u2(k, { children: [
      row.depth > 0 ? /* @__PURE__ */ u2("div", {
        "data-item-section": "spacing",
        children: Array.from({ length: row.depth }).map((_3, index) => /* @__PURE__ */ u2("div", {
          "data-item-section": "spacing-item",
      ...
      /* @__PURE__ */ u2("div", {
        "data-item-section": "icon",
        children: row.kind === "directory" ? /* @__PURE__ */ u2(Icon, { ...resolveIcon("file-tree-icon-chevron") }) : /* @__PURE__ */ u2(Icon, { ...resolveIcon("file-tree-icon-file", targetPath) })
      }),
      /* @__PURE__ */ u2("div", {
        "data-item-section": "content",
        children: row.isFlattened ? formatFlattenedSegments(row, renameInput, dragTargetFlattenedSegmentPath) : renameInput ?? /* @__PURE__ */ u2(MiddleTruncate, {
          minimumLength: 5,
          split: "extension",
          children: row.name
        })
      }),
      decorationLaneEnabled ? /* @__PURE__ */ u2("div", {
        "data-item-section": "decoration",
        children: customDecoration != null ? renderRowDecoration(customDecoration, resolveIcon) : null
      }) : null,
      gitLaneActive ? /* @__PURE__ */ u2("div", {
        "data-item-section": "git",
        children: renderRowDecoration(gitDecoration, resolveIcon)
      }) : null,
      actionLaneEnabled ? /* @__PURE__ */ u2("div", {
        "data-item-section": "action",
        children: showDecorativeActionAffordance ? /* @__PURE__ */ u2("span", {
          "aria-hidden": "true",
          "data-item-action-affordance": "decorative",
          children: /* @__PURE__ */ u2(Icon, { ...resolveIcon("file-tree-icon-ellipsis") })
        }) : null
      }) : null
    ] });
  }
  function renderStyledRow(frame, row, key, options = {}) {
    ...
    const renameInput = isSticky || !isRenamingRow ? null : /* @__PURE__ */ u2(RenameInput, {
    ...
    if (!isSticky && isRenamingRow) return /* @__PURE__ */ u2("div", {
      ...commonProps,
      children: rowContent
    });
  ...
  function FileTreeView({ composition, controller, gitStatusByPath, ignoredGitDirectories, directoriesWithGitChanges, icons, instanceId, itemHeight = FILE_TREE_DEFAULT_ITEM_HEIGHT, overscan = 10, renamingEnabled = false, renderRowDecoration: renderRowDecoration2, searchBlurBehavior = "close", searchEnabled = false, searchFakeFocus = false, slotHost, stickyFolders = false, initialViewportHeight = 420 }) {
    "use no memo";
    const contextMenuAnchorRef = F2(null);
    const contextMenuTriggerRef = F2(null);
    const isScrollingRef = F2(false);
    const listRef = F2(null);
    const renameInputRef = F2(null);
    const rootRef = F2(null);
    const scrollRef = F2(null);
    const searchInputRef = F2(null);
    const rowButtonRefs = F2(/* @__PURE__ */ new Map());
    const stickyRowButtonRefs = F2(/* @__PURE__ */ new Map());
    const updateViewportRef = F2(() => {
    });
    const measuredViewportHeightRef = F2(null);
    const processedScrollRequestIdRef = F2(0);
    const initialFocusedScrollAppliedRef = F2(false);
    const initialFocusedScrollControllerRef = F2(null);
    ...
    const domFocusOwnerRef = F2(false);
    const previousFocusedPathRef = F2(null);
    const previousRenamingPathRef = F2(null);
    const restoreTreeFocusAfterSearchCloseRef = F2(false);
    const restoreTreeFocusViewportOffsetRef = F2(null);
    const dragAutoScrollFrameRef = F2(null);
    const dragHoverOpenKeyRef = F2(null);
    const dragHoverOpenTimerRef = F2(null);
    const dragPointRef = F2(null);
    const dragPreviewRef = F2(null);
    const dragRowSnapshotRef = F2(null);
    const touchCleanupRef = F2(null);
    const touchDragActiveRef = F2(false);
    const touchPreviewOffsetRef = F2(null);
    const touchSourceElementRef = F2(null);
    const touchStartPointRef = F2(null);
    const touchLongPressTimerRef = F2(null);
    const ignoredInheritanceCache = q2(() => /* @__PURE__ */ new Map(), []);
    const [, setControllerRevision] = h2(0);
    const hasSeenInitialControllerSnapshotRef = F2(false);
    const [activeItemPath, setActiveItemPath] = h2(null);
    const [contextHoverPath, setContextHoverPath] = h2(null);
    const [contextMenuAnchorTop, setContextMenuAnchorTop] = h2(null);
    const [lastContextMenuInteraction, setLastContextMenuInteraction] = h2(null);
    const [scrollSettledRevision, setScrollSettledRevision] = h2(0);
    const [contextMenuState, setContextMenuState] = h2(null);
    const contextMenuStateRef = F2(contextMenuState);
    contextMenuStateRef.current = contextMenuState;
    const pendingStickyFocusPathRef = F2(null);
    const pendingStickyKeyboardFocusPathRef = F2(null);
    const pendingStickyKeyboardViewportOffsetRef = F2(null);
    const pendingStickyKeyboardScrollTopRef = F2(null);
    const debugContextMenuTriggerPathRef = F2(null);
    const debugDisableScrollSuppressionRef = F2(false);
    ...
    const skipInitialSearchAutoFocusRef = F2(searchBlurBehavior === "retain" && controller.isSearchOpen());
    const [fakeSearchFocusActive, setFakeSearchFocusActive] = h2(searchFakeFocus);
    _2(() => {
      if (!searchFakeFocus) setFakeSearchFocusActive(false);
    }, [searchFakeFocus]);
    const searchInputUserInteractedRef = F2(false);
    ...
    const [layoutState, setLayoutState] = h2(() => computeFileTreeViewLayoutState({
      controller,
      itemHeight,
      overscan,
      scrollTop: 0,
    ...
    const [hasStickyUiMount, setHasStickyUiMount] = h2(false);
    _2(() => {
    ...
    const { resolveIcon } = q2(() => createFileTreeIconResolver(icons), [icons]);
    ...
    const draggedPathSet = q2(() => dragSession == null ? null : new Set(dragSession.draggedPaths), [dragSession]);
    ...
    const stickyRowPathSet = q2(() => new Set(occludedStickyRows.map((entry) => getFileTreeRowPath(entry.row))), [occludedStickyRows]);
    const focusedRowIsMounted = focusedIndex >= 0 && focusedIndex >= range.start && focusedIndex <= range.end;
    const renderDecorationForRow = b((row, targetPath) => renderRowDecoration2?.({
      item: createContextMenuItem(row, targetPath),
      row
    }) ?? null, [renderRowDecoration2]);
    ...
    const restoreFocusToTreeRef = F2(restoreFocusToTree);
    restoreFocusToTreeRef.current = restoreFocusToTree;
    const shouldRestoreContextMenuFocusRef = F2(true);
    const closeContextMenuRef = F2(() => {
    });
    ...
    const handleTreeKeyDown = (event) => {
      ...
      if (isSearchOpen) {
        if (event.key === "Escape") {
          ...
          const viewportHeight = readMeasuredViewportHeight(scrollElement2, resolvedViewportHeight);
          restoreTreeFocusViewportOffsetRef.current = focusedIndex < 0 || scrollElement2 == null ? null : Math.max(0, Math.min(focusedIndex * itemHeight - scrollElement2.scrollTop, Math.max(0, viewportHeight - itemHeight)));
          restoreTreeFocusAfterSearchCloseRef.current = true;
          controller.closeSearch();
      ...
      if (activeStickyRowOwnsFocus && activeStickyFocusPath !== focusedPath && mountedStickyRowPathSet.has(activeStickyFocusPath)) {
        const scrollElement2 = scrollRef.current;
        preserveStickyKeyboardFocusAtScrollTop(activeStickyFocusPath, scrollElement2?.scrollTop ?? null);
    ...
    A2(() => {
      ...
      const unsubscribe = controller.subscribe(() => {
        if (shouldBumpControllerRevision(hasSeenInitialControllerSnapshotRef)) setControllerRevision((revision) => revision + 1);
        update();
      });
      const markScrolling = () => {
    ...
    const activeContextMenuKey = q2(() => contextMenuState == null ? null : `${contextMenuState.path}::${contextMenuState.source}`, [contextMenuState]);
    A2(() => {
    ...
    const handleTreePointerOver = b((event) => {
      ...
      if (target.closest?.(`[data-type="context-menu-trigger"]`) != null) return;
    ...
    return /* @__PURE__ */ u2("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ u2("div", {
          ref: scrollRef,
          "data-file-tree-virtualized-scroll": "true",
          children: [stickyFolders && hasStickyUiMount && stickyRows.length > 0 ? /* @__PURE__ */ u2("div", {
            "aria-hidden": "true",
            "data-file-tree-sticky-overlay": "true",
            children: /* @__PURE__ */ u2("div", {
              "data-file-tree-sticky-overlay-content": "true",
        ...
        contextMenuEnabled ? /* @__PURE__ */ u2("div", {
          ...
          children: [/* @__PURE__ */ u2("button", {
            ...
            children: /* @__PURE__ */ u2(Icon, { ...resolveIcon("file-tree-icon-ellipsis") })
          }), contextMenuState != null ? /* @__PURE__ */ u2("slot", { name: CONTEXT_MENU_SLOT_NAME }) : null]
        }) : null,
        contextMenuState != null ? /* @__PURE__ */ u2("div", {
          "data-type": "context-menu-wash",
          "aria-hidden": "true",
  ...
  // node_modules/@pierre/trees/dist/render/runtime.js
  var fileTreeRenderer = {
    hydrateRoot: (element, props) => {
      G(_(FileTreeView, props), element);
    },
    renderRoot: (element, props) => {
      F(_(FileTreeView, props), element);
    },
    unmountRoot: (element) => {
      F(null, element);
    }
  ...
  // node_modules/@pierre/trees/dist/render/slotHost.js
  ...
  // node_modules/@pierre/trees/dist/render/FileTree.js
  var clientInstanceId = 0;
  ...
  function resolveInitialViewportHeight({ initialVisibleRowCount, itemHeight }) {
    return initialVisibleRowCount == null ? 420 : Math.max(0, initialVisibleRowCount) * (itemHeight ?? FILE_TREE_DEFAULT_ITEM_HEIGHT);
  }
  ...
  var FileTree = class {
    ...
    constructor(options) {
      const { composition, density, fileTreeSearchMode, gitStatus, id, initialSearchQuery, icons, itemHeight, onSearchChange, onSelectionChange, overscan, renderRowDecoration: renderRowDecoration2, renaming, search, searchBlurBehavior, searchFakeFocus, stickyFolders, unsafeCSS, initialVisibleRowCount, ...controllerOptions } = options;
    ...
    resetPaths(pathsOrOptions, options) {
      if (Array.isArray(pathsOrOptions)) this.#controller.resetPaths(pathsOrOptions, options);
      else this.#controller.resetPaths(pathsOrOptions);
    }
    ...
    #prepareHost(fileTreeContainer, parentNode) {
      const host = fileTreeContainer ?? this.#fileTreeContainer ?? document.createElement("file-tree-container");
  ...
  var requestedTheme = params.get("theme") || "system";
  var systemDark = window.matchMedia("(prefers-color-scheme: dark)");
  var mount = document.querySelector("#tree-mount");
  var status = document.querySelector("#tree-status");
  var dialogRoot = document.querySelector("#dialog-root");
  var filesTab = document.querySelector("#tab-files");
  var searchTab = document.querySelector("#tab-search");
  var filesPanel = document.querySelector("#panel-files");
  var searchPanel = document.querySelector("#panel-search");
  var filesActions = document.querySelector("#files-actions");
  var newFileButton = document.querySelector("#action-new-file");
  var newFolderButton = document.querySelector("#action-new-folder");
  var searchQueryInput = document.querySelector("#search-query");
  var searchIncludeInput = document.querySelector("#search-include");
  var searchExcludeInput = document.querySelector("#search-exclude");
  var searchCaseButton = document.querySelector("#search-case");
  var searchWordButton = document.querySelector("#search-word");
  var searchFiltersToggle = document.querySelector("#search-filters-toggle");
  ...
  var searchAutoPageLimit = 12;
  var searchDebounceMs = 220;
  var tree;
  var treeRootLabel = "project";
  var treeEditable = false;
  var lastOpenedPath = "";
  var clipboardPath = null;
  var clipboardKey = `docyrus:explorer-clipboard:${projectId}`;
  var draggedFilePath = "";
  var dragOrigin = null;
  ...
  async function applyDrop(event) {
    ...
    setStatus(
      moves.length === 1 ? `Moved ${basenameOf(moves[0].source)} to ${displayDirectory(directory)}` : `Moved ${moves.length} items to ${displayDirectory(directory)}`
    );
  }
  ...
  async function deleteEntry(path) {
    ...
    const confirmed = await openDialog({
      title: `Delete ${name}?`,
      message: isDirectoryPath(path) ? "This folder and everything inside it is deleted from disk." : "This file is deleted from disk.",
      confirmLabel: "Delete",
      variant: "destructive"
    });
    if (!confirmed) return;
    try {
      ...
      tree?.remove(path, isDirectoryPath(path) ? { recursive: true } : void 0);
  ...
  async function renderTree() {
    ...
    try {
      ...
      tree = new FileTree({
        ...
        composition: editable ? { contextMenu: { enabled: true, triggerMode: "both", render: renderContextMenu } } : void 0
      });
      ...
      setStatus(
        paths.length === 0 ? `No files in ${root}` : `${paths.length} items in ${root}${notes.length ? ` \u2022 ${notes.join(" \u2022 ")}` : ""}`
      );
    } catch (error) {
  ...
  function beginRowDrag(event) {
    ...
    dragOrigin = event.screenX === 0 && event.screenY === 0 ? null : { x: event.screenX - event.clientX, y: event.screenY - event.clientY };
    draggedPoint = null;
  }
  ...
  var searchOptions = { matchCase: false, wholeWord: false };
  var searchToken = 0;
  var searchGroups = /* @__PURE__ */ new Map();
  var searchMatchCount = 0;
  var searchCursor = { fileOffset: 0, matchOffset: 0 };
  var searchComplete = true;
  var searchRunning = false;
  var searchDebounce = 0;
  var collapsedSearchGroups = /* @__PURE__ */ new Set();
  ...
  async function continueSearch(reset = false) {
    ...
    try {
      ...
      searchRunning = false;
      renderSearchResults();
      searchSummary.textContent = searchMatchCount === 0 ? "No results found" : summarizeSearch(searchComplete ? null : "more available");
    } catch (error) {
      if (token !== searchToken) return;
      searchRunning = false;
